...
CREATE OR REPLACE FUNCTION "public"."set_primary_persona_once"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    -- This function can be used to enforce business rules around primary personas
...
ALTER FUNCTION "public"."set_primary_persona_once"() OWNER TO "postgres";
...
CREATE INDEX "idx_people_personas_interview_id" ON "public"."people_personas" USING "btree" ("interview_id");
...
CREATE OR REPLACE TRIGGER "set_people_personas_timestamp" BEFORE INSERT OR UPDATE ON "public"."people_personas" FOR EACH ROW EXECUTE FUNCTION "accounts"."trigger_set_timestamps"();



CREATE OR REPLACE TRIGGER "set_people_personas_user_tracking" BEFORE INSERT OR UPDATE ON "public"."people_personas" FOR EACH ROW EXECUTE FUNCTION "accounts"."trigger_set_user_tracking"();
...
CREATE POLICY "Users can delete people_personas for their account" ON "public"."people_personas" FOR DELETE USING (("person_id" IN ( SELECT "people"."id"
   FROM "public"."people"
  WHERE ("people"."account_id" IN ( SELECT "accounts"."get_accounts_with_role"('owner'::"accounts"."account_role") AS "get_accounts_with_role")))));
...
CREATE POLICY "Users can insert people_personas for their account" ON "public"."people_personas" FOR INSERT WITH CHECK (("person_id" IN ( SELECT "people"."id"
   FROM "public"."people"
  WHERE ("people"."account_id" IN ( SELECT "accounts"."get_accounts_with_role"('owner'::"accounts"."account_role") AS "get_accounts_with_role")))));
...
CREATE POLICY "Users can update people_personas for their account" ON "public"."people_personas" FOR UPDATE USING (("person_id" IN ( SELECT "people"."id"
   FROM "public"."people"
  WHERE ("people"."account_id" IN ( SELECT "accounts"."get_accounts_with_role"('owner'::"accounts"."account_role") AS "get_accounts_with_role")))));
...
CREATE POLICY "Users can view people_personas for their account" ON "public"."people_personas" FOR SELECT USING (("person_id" IN ( SELECT "people"."id"
   FROM "public"."people"
  WHERE ("people"."account_id" IN ( SELECT "accounts"."get_accounts_with_role"('owner'::"accounts"."account_role") AS "get_accounts_with_role")))));
...
GRANT ALL ON FUNCTION "public"."set_primary_persona_once"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_primary_persona_once"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_primary_persona_once"() TO "service_role";
