    ...
    extensions: [
      syncEnvVars(async (ctx) => {
        ...
        return [
          ...
          { name: "RECALLAI_API_KEY", value: process.env.RECALLAI_API_KEY || "" },
          { name: "RECALLAI_REGION", value: process.env.RECALLAI_REGION || "" },
          { name: "RECALLAI_WEBHOOK_SECRET", value: process.env.RECALLAI_WEBHOOK_SECRET || "" },
