...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_constraint WHERE conname = 'conversation_lens_analyses_account_id_fkey'
  ) THEN
    ALTER TABLE "public"."conversation_lens_analyses"
      ADD CONSTRAINT "conversation_lens_analyses_account_id_fkey"
      FOREIGN KEY (account_id) REFERENCES accounts.accounts(id) ON DELETE CASCADE;
  END IF;
END $$;

-- Safely add constraints (drop first if exists)
DO $$
BEGIN
  ...
  ALTER TABLE "public"."conversation_lens_analyses" ADD CONSTRAINT "conversation_lens_analyses_confidence_score_check"
  ...
  ALTER TABLE "public"."conversation_lens_analyses" ADD CONSTRAINT "conversation_lens_analyses_interview_id_fkey"
  ...
  ALTER TABLE "public"."conversation_lens_analyses" ADD CONSTRAINT "conversation_lens_analyses_processed_by_fkey"
  ...
  ALTER TABLE "public"."conversation_lens_analyses" ADD CONSTRAINT "conversation_lens_analyses_project_id_fkey"
  ...
  ALTER TABLE "public"."conversation_lens_analyses" ADD CONSTRAINT "conversation_lens_analyses_status_check"
  ...
  ALTER TABLE "public"."conversation_lens_analyses" ADD CONSTRAINT "conversation_lens_analyses_template_key_fkey"
    FOREIGN KEY (template_key) REFERENCES public.conversation_lens_templates(template_key) ON DELETE RESTRICT;
  ...
  ALTER TABLE "public"."comments" ADD CONSTRAINT "comments_insight_id_fkey"
    FOREIGN KEY (insight_id) REFERENCES public.insights(id) ON DELETE CASCADE;

  -- insight_tags constraint
  ...
  -- opportunity_insights constraint
