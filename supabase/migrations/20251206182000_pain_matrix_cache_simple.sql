-- Pain Matrix Cache Table (create if not exists)
...
drop trigger if exists set_pain_matrix_cache_timestamp on pain_matrix_cache;
...
drop policy if exists "Account members can view cached matrices" on pain_matrix_cache;
drop policy if exists "Account members can insert cached matrices" on pain_matrix_cache;
drop policy if exists "Account members can update cached matrices" on pain_matrix_cache;
drop policy if exists "Account owners can delete cached matrices" on pain_matrix_cache;
drop policy if exists "Service role can manage all cached matrices" on pain_matrix_cache;
