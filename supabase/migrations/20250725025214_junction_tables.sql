...
CREATE TABLE IF NOT EXISTS insight_tags (
    ...
    -- Ensure unique insight-tag pairs
...
CREATE TABLE IF NOT EXISTS interview_tags (
    ...
    -- Ensure unique interview-tag pairs
...
CREATE INDEX IF NOT EXISTS idx_insight_tags_tag ON insight_tags(tag, account_id);

CREATE INDEX IF NOT EXISTS idx_interview_tags_interview_id ON interview_tags(interview_id);
CREATE INDEX IF NOT EXISTS idx_interview_tags_tag ON interview_tags(tag, account_id);
