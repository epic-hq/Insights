-- Fix: user_email return type must match auth.users.email (varchar(255))

DROP FUNCTION IF EXISTS public.get_admin_usage_by_user(TIMESTAMPTZ, TIMESTAMPTZ);
...
BEGIN
    ...
    SELECT
        ...
        COALESCE(au.raw_user_meta_data->>'full_name', au.email::TEXT) AS user_name,
