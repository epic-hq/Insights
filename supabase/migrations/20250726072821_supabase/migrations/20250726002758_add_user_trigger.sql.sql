drop function if exists "accounts"."run_new_user_setup"();
...
create table "public"."people_personas" (
...
CREATE UNIQUE INDEX people_personas_pkey ON public.people_personas USING btree (person_id, persona_id);

CREATE UNIQUE INDEX tags_account_tag_unique ON public.tags USING btree (account_id, tag);

alter table "public"."people_personas" add constraint "people_personas_pkey" PRIMARY KEY using index "people_personas_pkey";

alter table "public"."people_personas" add constraint "people_personas_created_by_fkey" FOREIGN KEY (created_by) REFERENCES auth.users(id) not valid;

alter table "public"."people_personas" validate constraint "people_personas_created_by_fkey";

alter table "public"."people_personas" add constraint "people_personas_interview_id_fkey" FOREIGN KEY (interview_id) REFERENCES interviews(id) ON DELETE SET NULL not valid;

alter table "public"."people_personas" validate constraint "people_personas_interview_id_fkey";

alter table "public"."people_personas" add constraint "people_personas_person_id_fkey" FOREIGN KEY (person_id) REFERENCES people(id) ON DELETE CASCADE not valid;

alter table "public"."people_personas" validate constraint "people_personas_person_id_fkey";

alter table "public"."people_personas" add constraint "people_personas_persona_id_fkey" FOREIGN KEY (persona_id) REFERENCES personas(id) ON DELETE CASCADE not valid;

alter table "public"."people_personas" validate constraint "people_personas_persona_id_fkey";

alter table "public"."people_personas" add constraint "people_personas_project_id_fkey" FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE SET NULL not valid;

alter table "public"."people_personas" validate constraint "people_personas_project_id_fkey";
...
grant delete on table "public"."people_personas" to "anon";

grant insert on table "public"."people_personas" to "anon";

grant references on table "public"."people_personas" to "anon";

grant select on table "public"."people_personas" to "anon";

grant trigger on table "public"."people_personas" to "anon";

grant truncate on table "public"."people_personas" to "anon";

grant update on table "public"."people_personas" to "anon";

grant delete on table "public"."people_personas" to "authenticated";

grant insert on table "public"."people_personas" to "authenticated";

grant references on table "public"."people_personas" to "authenticated";

grant select on table "public"."people_personas" to "authenticated";

grant trigger on table "public"."people_personas" to "authenticated";

grant truncate on table "public"."people_personas" to "authenticated";

grant update on table "public"."people_personas" to "authenticated";

grant delete on table "public"."people_personas" to "service_role";

grant insert on table "public"."people_personas" to "service_role";

grant references on table "public"."people_personas" to "service_role";

grant select on table "public"."people_personas" to "service_role";

grant trigger on table "public"."people_personas" to "service_role";

grant truncate on table "public"."people_personas" to "service_role";

grant update on table "public"."people_personas" to "service_role";

create policy "Users can modify people_personas for their account"
...
create policy "Users can view people_personas for their account"
on "public"."people_personas"
as permissive
for select
to public
