-- Add public function to record usage events
-- This allows server code to insert into billing.usage_events without exposing the schema
...
-- Grant execute to authenticated users (server uses service role anyway)
