...
alter table "accounts"."accounts" add constraint "accounts_accounts_slug_null_if_personal_account_true" CHECK ((((personal_account = true) AND (slug IS NULL)) OR (personal_account = false))) not valid;
