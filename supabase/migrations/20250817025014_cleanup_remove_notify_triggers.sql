drop trigger if exists "analysis_job_notify" on "public"."analysis_jobs";

drop trigger if exists "upload_job_notify" on "public"."upload_jobs";

drop function if exists "public"."notify_analysis_job"();

drop function if exists "public"."notify_upload_job"();
