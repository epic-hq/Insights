drop policy "Account members can insert" on "public"."interviews";

drop policy "Account members can select" on "public"."interviews";

drop policy "Account members can update" on "public"."interviews";

drop policy "Account owners can delete" on "public"."interviews";

drop policy "Users can insert analysis jobs for their interviews" on "public"."analysis_jobs";

drop policy "Users can update analysis jobs for their interviews" on "public"."analysis_jobs";

drop policy "Users can view analysis jobs for their interviews" on "public"."analysis_jobs";

drop policy "Users can insert upload jobs for their interviews" on "public"."upload_jobs";

drop policy "Users can update upload jobs for their interviews" on "public"."upload_jobs";

drop policy "Users can view upload jobs for their interviews" on "public"."upload_jobs";

drop view if exists "public"."persona_distribution";

alter table "public"."insights" alter column "created_by" drop not null;

alter table "public"."project_sections" alter column "created_by" drop not null;

alter table "public"."project_sections" alter column "updated_by" drop not null;
