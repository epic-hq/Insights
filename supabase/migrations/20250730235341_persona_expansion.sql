...
alter table "public"."personas" add column "age" text;

alter table "public"."personas" add column "awareness_stage" text;

alter table "public"."personas" add column "education" text;

alter table "public"."personas" add column "frequency_of_purchase" text;

alter table "public"."personas" add column "frequency_of_use" text;

alter table "public"."personas" add column "frustrations" text[];

alter table "public"."personas" add column "gender" text;

alter table "public"."personas" add column "income" text;

alter table "public"."personas" add column "key_tasks" text[];

alter table "public"."personas" add column "languages" text;

alter table "public"."personas" add column "learning_style" text;

alter table "public"."personas" add column "location" text;

alter table "public"."personas" add column "motivations" text[];

alter table "public"."personas" add column "occupation" text;

alter table "public"."personas" add column "preferences" text;

alter table "public"."personas" add column "primary_goal" text;

alter table "public"."personas" add column "quotes" text[];

alter table "public"."personas" add column "role" text;

alter table "public"."personas" add column "secondary_goals" text[];

alter table "public"."personas" add column "segment" text;

alter table "public"."personas" add column "sources" text[];

alter table "public"."personas" add column "tech_comfort_level" text;

alter table "public"."personas" add column "tools_used" text[];

alter table "public"."personas" add column "values" text[];
