...
alter table "public"."insights" add column "project_id" uuid;

alter table "public"."interview_people" add column "project_id" uuid;

alter table "public"."tags" add column "project_id" uuid;

alter table "public"."insights" add constraint "insights_project_id_fkey" FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE not valid;

alter table "public"."insights" validate constraint "insights_project_id_fkey";

alter table "public"."interview_people" add constraint "interview_people_project_id_fkey" FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE not valid;

alter table "public"."interview_people" validate constraint "interview_people_project_id_fkey";

alter table "public"."tags" add constraint "tags_project_id_fkey" FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE not valid;

alter table "public"."tags" validate constraint "tags_project_id_fkey";
