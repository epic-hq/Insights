-- Fix project ordering in get_user_accounts RPC
-- Orders projects by updated_at DESC so most recently used appears first
-- This fixes the bug where project ID would "drift" to the first project in random order
