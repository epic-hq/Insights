-- Fix functions that still reference 'created' instead of 'created_at'
-- This is a follow-up to 20260122215900 which renamed the column but
-- some function updates were missing
...
-- Update get_account_billing_status function
...
-- Update service_role_upsert_customer_subscription function
