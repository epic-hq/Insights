...
alter table "public"."opportunities" drop constraint "opportunities_kanban_status_check";
...
drop index if exists "public"."idx_interviews_person_id";

drop index if exists "public"."idx_upload_jobs_created_by";

alter table "public"."projects" add column "project_settings" jsonb not null default '{}'::jsonb;
