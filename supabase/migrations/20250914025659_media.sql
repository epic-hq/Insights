...
alter table "public"."interviews" drop column "duration_min";

alter table "public"."interviews" add column "created_by" uuid;

alter table "public"."interviews" add column "duration_sec" integer;

alter table "public"."interviews" add column "updated_by" uuid;

alter table "public"."interviews" add constraint "interviews_created_by_fkey" FOREIGN KEY (created_by) REFERENCES auth.users(id) not valid;

alter table "public"."interviews" validate constraint "interviews_created_by_fkey";

alter table "public"."interviews" add constraint "interviews_updated_by_fkey" FOREIGN KEY (updated_by) REFERENCES auth.users(id) not valid;

alter table "public"."interviews" validate constraint "interviews_updated_by_fkey";
