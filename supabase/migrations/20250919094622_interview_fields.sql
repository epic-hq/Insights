create sequence "public"."interview_people_id_seq";

drop view if exists "public"."persona_distribution";

alter table "public"."interview_people" drop constraint "interview_people_pkey";

drop index if exists "public"."interview_people_pkey";

alter table "public"."interview_people" add column "id" bigint not null default nextval('interview_people_id_seq'::regclass);

alter table "public"."interviews" add column "relevant_answers" text[];

alter sequence "public"."interview_people_id_seq" owned by "public"."interview_people"."id";

CREATE UNIQUE INDEX interview_people_interview_id_person_id_key ON public.interview_people USING btree (interview_id, person_id);

CREATE UNIQUE INDEX interview_people_pkey ON public.interview_people USING btree (id);

alter table "public"."interview_people" add constraint "interview_people_pkey" PRIMARY KEY using index "interview_people_pkey";

alter table "public"."interview_people" add constraint "interview_people_interview_id_person_id_key" UNIQUE using index "interview_people_interview_id_person_id_key";
