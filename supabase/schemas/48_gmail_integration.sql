...
-- Pattern matches 48_calendar_integration.sql but simplified (no legacy OAuth token fields)
...
-- Updated_at triggers (reuse the function from calendar integration)
