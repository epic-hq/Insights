...
$$
    BEGIN
        ...
        IF NOT EXISTS(SELECT 1
            ...
            CREATE TYPE accounts.account_role AS ENUM ('owner', 'member', 'viewer');
        end if;
    end;
$$;
...
/**
  Allows a user to leave an account (remove themselves).
  Primary owners cannot leave their own account - they must transfer ownership or delete the account.
 */
