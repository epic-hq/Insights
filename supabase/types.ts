...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      projects: {
        Row: {
          ...
          public_allow_chat: boolean | null
          public_calendar_url: string | null
          public_cta_helper: string | null
    ...
    Functions: {
      ...
      finalize_survey_response: {
        Args: { p_interview_id: string; p_prompts: Json }
        Returns: undefined
      }
