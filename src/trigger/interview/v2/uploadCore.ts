...
export async function uploadMediaAndTranscribeCore({
  ...
  consola.info("[uploadMediaAndTranscribeCore] After sanitization", {
    ...
    wordsCount: sanitizedTranscriptData.words?.length ?? 0,
    hasWords: Array.isArray(sanitizedTranscriptData.words),
    wordsSample: sanitizedTranscriptData.words?.slice?.(0, 2) ?? null,
