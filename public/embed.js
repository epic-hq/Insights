 ...
 *   data-upsight-theme: "transparent" | "dark" | "light" (default: "transparent")
...
(function () {
  ...
  function initEmbeds() {
    ...
    containers.forEach(function (container) {
      ...
      var config = {
        ...
        theme: container.dataset.upsightTheme || "transparent",
      ...
      window.addEventListener("message", function (event) {
        ...
        if (
          !event.origin.includes("getupsight.com") &&
          ...
          mutation.addedNodes.forEach(function (node) {
            if (
              ...
              (node.dataset?.upsightSlug ||
                ...
                node.querySelector?.("[data-upsight-slug], .upsight-embed"))
            ) {
              shouldInit = true;
            }
          });
  ...
  window.UpSight.create = function (containerId, slug, options) {
    ...
    if (options.radius)
      container.dataset.upsightRadius = String(options.radius);
