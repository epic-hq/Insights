 ...
 */
export async function extractAudioOnly(file: File, options: OptimizeOptions = {}): Promise<OptimizationResult> {
	...
	try {
		...
		console.warn("[MediaOptimizer] Audio extraction failed, returning original:", message);
