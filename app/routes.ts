...
const routes = [
	...
	layout("./routes/_ProtectedLayout.tsx", [
		...
		// Gmail integration routes (protected, need user context)
		route("api/gmail/save-connection", "./routes/api.gmail.save-connection.tsx"),
		route("api/gmail/disconnect", "./routes/api.gmail.disconnect.tsx"),
		route("api/gmail/send-survey", "./routes/api.gmail.send-survey.tsx"),
	...
	// Dev routes
	route("dev/widget-gallery", "./routes/dev.widget-gallery.tsx"),
