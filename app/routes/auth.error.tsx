  ...
  switch (code) {
    case "otp_expired":
      return {
        title: "Link Expired",
        message:
          "This password reset link has expired. Reset links are only valid for a limited time.",
        action: {
    ...
    case "validation_failed":
      return {
        title: "Invalid Link",
        message:
          "This link is invalid or has already been used. Each reset link can only be used once.",
        action: {
          label: "Request New Link",
          href: "/forgot-password",
        },
