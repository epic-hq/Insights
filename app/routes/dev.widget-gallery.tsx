...
const conversationLensInsightsData = {
	...
	analysisData: {
			...
			},
			{
				...
				fields: [
					...
					},
					{
						...
						text_array_value: ["AI might misinterpret nuanced customer feedback", "Team adoption of yet another tool"],
					},
					{
						field_key: "habits_inertia",
						field_label: "Habits & Inertia",
						text_array_value: ["Existing Notion/Miro workflow is 'good enough'"],
					},
				],
			},
			{
				...
				fields: [
					{
						...
						text_array_value: ["AI-powered pattern detection across interviews", "Auto-generated stakeholder briefs"],
					},
					{
						field_key: "highest_priority_opportunity",
						field_label: "Top Opportunity",
						text_array_value: ["Enhance AI reliability so teams trust the synthesis"],
					},
				],
			},
		],
		recommendations: [
			{
				priority: "high",
				description: "Enhance AI reliability tooling to build trust in synthesis quality",
			},
			{
				priority: "medium",
				description: "Implement side-by-side evidence comparison for conflicting signals",
			},
			{
				priority: "low",
				...
				fields: [
					{
						...
						value: "Teams lack a unified view of customer feedback, leading to gut-based decisions.",
					},
					{
						field_key: "severity",
				...
				fields: [
					{
						...
						text_array_value: ["Notion databases", "Miro boards", "Manual spreadsheet tracking"],
					},
					{
	...
	return (
		<div className="min-h-screen bg-background p-8">
			<div className="mx-auto max-w-4xl space-y-12">
				...
				<Section title="ConversationLensInsights (JTBD)" moment="Canvas — JTBD analysis with forces, journey, recs">
					<ConversationLensInsights data={conversationLensInsightsData} />
				</Section>

				<Section title="ConversationLensInsights (Generic)" moment="Canvas — Non-JTBD lens with section cards">
