	...
	evidence: z.array(
		z.object({
			...
			updates_gist: z
				.string()
				.optional()
				.describe('When action is "update", the gist of the existing evidence being updated'),
			gist: z.string().describe("≤12 word essence of the insight"),
			category: z.enum(["pain", "goal", "workflow", "tool", "context"]).describe("Type of insight"),
