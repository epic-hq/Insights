...
export const displayInterviewPromptsTool = createTool({
	...
	inputSchema: z.object({
		title: z.string().optional().describe("Title for the prompts section, e.g. 'Customer Discovery Questions'"),
		description: z.string().optional().describe("Brief description of what these prompts cover"),
		prompts: z
			.array(
				z.object({
