...
const toolInputSchema = z.object({
  ...
  organizationId: z
    .string()
    .nullish()
    .describe("Required for update, delete, and get actions"),
  accountId: z.string().nullish(),
  projectId: z.string().nullish(),
  data: organizationSchema
    .partial()
    .nullish()
    .describe("Organization data for create/update actions"),
});
    ...
    try {
      ...
      if (action === "update") {
        ...
        if (data.size_range !== undefined)
          updateData.size_range = data.size_range;
        if (data.company_type !== undefined)
          updateData.company_type = data.company_type;
        if (data.headquarters_location !== undefined)
          updateData.headquarters_location = data.headquarters_location;
