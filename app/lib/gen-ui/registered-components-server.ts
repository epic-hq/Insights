...
componentRegistry.register({
	...
	useWhen: "User asks for interview questions, wants to prepare for an interview, or needs a question list.",
	triggerExamples: ["interview questions", "prepare for interview", "question list"],
});
