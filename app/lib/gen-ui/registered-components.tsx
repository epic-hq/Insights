...
/**
 * Conversation Lens Insights - Rich analysis canvas widget
 */
import { ClipboardList } from "lucide-react";
import {
	ConversationLensInsights,
	type ConversationLensInsightsData,
} from "~/features/generative-ui/components/ConversationLensInsights";
...
defineComponent<ConversationLensInsightsData>({
	...
	component: ConversationLensInsights as React.ComponentType<{
...
/**
 * DecisionSupport - Recommended actions with commit (Moment 7)
 */
defineComponent({
	...
	component: DecisionSupport as React.ComponentType<{
		data: unknown;
		isStreaming?: boolean;
	}>,
