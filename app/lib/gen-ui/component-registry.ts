...
export const progressRailPhaseSchema = z.object({
  id: z
    .enum(["frame", "collect", "validate", "commit", "measure"])
    .catch("frame"),
  label: z.string().catch(""),
  status: z
    .enum(["complete", "active", "upcoming", "blocked"])
    .catch("upcoming"),
...
export const surveyOutreachRecipientSchema = z.object({
  ...
  status: z
    .enum(["pending", "sent", "opened", "completed", "bounced"])
    .catch("pending"),
});
...
export const intakeHealthDataSchema = z.object({
  projectId: z.string(),
  confidenceTier: z
    .enum(["early_signal", "growing_confidence", "decision_ready"])
    .nullable()
    .catch("early_signal"),
  ...
  gateStatus: z
    .enum(["insufficient", "marginal", "sufficient"])
    .nullable()
    .catch("insufficient"),
...
export const patternSchema = z.object({
  ...
  confidenceTier: z
    .enum(["thin", "emerging", "strong", "validated"])
    .catch("emerging"),
