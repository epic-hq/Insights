...
/**
 * DEPRECATED: findByNameCompanyLegacy removed in Phase 3E.
 * The 'company' column was dropped in migration 20260210000005.
 * All person resolution now uses default_organization_id FK.
 * See resolveOrganization() for company text -> org UUID resolution.
 */
