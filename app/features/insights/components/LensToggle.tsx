...
export function LensToggle({ activeLens }: LensToggleProps) {
	...
	return (
		<ToggleGroup type="single" value={activeLens} size="sm" className="shrink-0">
			<ToggleGroupItem value="themes" aria-label="By Theme" className="gap-2" asChild>
				<Link to={routes.insights.themes()}>
					<Tags className="h-4 w-4" />
					By Theme
				</Link>
			</ToggleGroupItem>
			<ToggleGroupItem value="stakeholders" aria-label="By Stakeholder" className="gap-2" asChild>
