...
import { Check, Clock4, Copy, DoorOpen, Info, LinkIcon, RefreshCw, ShieldOff, UserMinus } from "lucide-react"
		...
		<PageContainer size="sm" padded={false} className="container max-w-3xl py-6">
			<div className="mb-6 space-y-2">
				...
				<div className="space-y-1 text-muted-foreground text-sm">
					...
					<p>
						Your role:{" "}
						<span className="font-medium text-foreground capitalize">{account?.account_role || "member"}</span>
