...
export function ResourceShareMenu({
  ...
  // Public share state
  const [publicShareEnabled, setPublicShareEnabled] =
    useState(initialShareEnabled);
  const [publicShareToken, setPublicShareToken] = useState(initialShareToken);
  const [expirationDays, setExpirationDays] = useState<"7" | "30" | "never">(
    "30",
  );
      ...
      >
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              Create a public link to share this interview with anyone, no login
              required.
            </DialogDescription>
          </DialogHeader>
              ...
              <>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleUpdateExpiration(value as "7" | "30" | "never")
                    }
                    disabled={isShareUpdating}
                  >
                ...
                <p className="text-muted-foreground text-xs">
                  Anyone with this link can view the interview transcript,
                  recording, and AI analysis. User notes and team comments are
                  not visible.
                </p>
              </>
            )}
          ...
          <DialogFooter>
            <Button
              variant="outline"
              onClick={() => setPublicShareDialogOpen(false)}
            >
              Done
            </Button>
          </DialogFooter>
