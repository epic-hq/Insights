...
export function InsightsExplainerCard({
	...
	const tooManyThemes = themeCount > 15 && hasEnoughForConsolidation && !hasConsolidated
			...
			<Alert className="border-amber-200 bg-amber-50/50 dark:border-amber-900 dark:bg-amber-950/20">
				...
				<AlertDescription className="text-amber-800 dark:text-amber-200">
					<p className="mb-3">
						...
						lot to navigate. Consolidation will merge similar themes into 5-12 powerful insights.
					</p>
