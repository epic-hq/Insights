...
export function InsightsSettingsModal({
  ...
  const initialThemeDedup =
    currentSettings?.theme_dedup_threshold ?? DEFAULT_THEME_DEDUP;
  const initialEvidenceLink =
    currentSettings?.evidence_link_threshold ?? DEFAULT_EVIDENCE_LINK;
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <fetcher.Form
          method="post"
          action={"/api/update-analysis-settings"}
          className="space-y-6"
        >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <p className="text-muted-foreground text-xs">
                ...
                <span className="text-foreground/70">
                  Higher = fewer but more relevant links
                </span>
                .
              </p>
            </div>
