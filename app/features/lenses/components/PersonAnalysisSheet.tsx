...
export function PersonAnalysisSheet({
  person,
  open,
  onOpenChange,
  routes,
            ...
            {person.lensHighlights.some((h) => h.executiveSummary) && (
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  {
                    person.lensHighlights.find((h) => h.executiveSummary)
                      ?.executiveSummary
                  }
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <ul className="space-y-2">
                  {person.surveyHighlights.map((gist, i) => (
                    <li
                      key={i}
                      className="rounded-md border bg-blue-50/50 p-2.5 text-sm text-foreground/80 dark:bg-blue-950/20"
                    >
                      {gist}
                    </li>
                  ))}
              ...
              !hasSurveyHighlights && (
                <div className="py-8 text-center">
                  ...
                  <p className="mt-1 text-muted-foreground/70 text-xs">
                    Analysis runs automatically after conversations are
                    processed.
                  </p>
                </div>
              )}
