...
export function EvidenceModal({
  ...
  const effectiveStartTime =
    startTime ??
    (evidence?.anchors?.[0]
      ? getAnchorStartSeconds(evidence.anchors[0] as MediaAnchor)
      : 0);
  const isValidUrl =
              ...
              <div className="border-b bg-black/5 p-4 dark:bg-white/5">
                {isLoadingMedia ? (
                  ...
                  <SimpleMediaPlayer
                    ...
                    thumbnailUrl={
                      evidence.interview?.thumbnail_url ?? undefined
                    }
                  />
                ) : null}
              </div>
            ...
            {evidence.chunk && (
              <div className="px-6 py-4">
                <blockquote
                  ...
                  style={{
                    borderLeftColor: getStageColor(evidence.journey_stage),
                  }}
                >
                  "{evidence.chunk}"
                </blockquote>
              ...
              {evidence.facets?.length > 0 && (
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {evidence.facets.map((facet) => (
                    <Badge
                      key={`${facet.kind_slug}-${facet.label}`}
                      variant="outline"
                      className="text-xs"
                    >
                      {facet.label}
                  ...
                  <span className="flex items-center gap-1">
                    ...
                    <Badge
                      ...
                      className={cn(
                        ...
                        evidence.support.toLowerCase() === "refutes" &&
