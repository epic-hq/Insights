				...
				<CardContent className="space-y-4">
						...
						<div className="flex items-start gap-2 rounded-md border border-yellow-200 bg-yellow-50/50 p-3 dark:border-yellow-800/50 dark:bg-yellow-950/20">
							...
							<div className="text-xs">
								...
								<p className="mt-0.5 text-yellow-700 dark:text-yellow-400">
									{missingTitle > 0 && (
										<span>
											{missingTitle}/{dataQuality.totalPeople} people missing job title.{" "}
										</span>
									)}
									{missingCompany > 0 && (
										<span>
					...
					{totalScored > 0 && (
						<div className="border-t pt-4">
							<p className="mb-2 font-medium text-foreground/60 text-xs">Match Distribution ({totalScored} scored)</p>
					...
					{scoredPeople.length > 0 && (
						<div className="border-t pt-4">
							<p className="mb-2 font-medium text-foreground/60 text-xs">People Scores</p>
