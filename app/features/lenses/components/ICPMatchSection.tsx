        ...
        <DialogContent className="max-h-[85vh] max-w-[1200px] sm:max-w-[1200px]">
          ...
          <div className="grid grid-cols-1 gap-8 py-4 sm:grid-cols-[1fr_1.2fr]">
            ...
            <div className="flex flex-col gap-5">
              <div className="border-b pb-1.5 text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">
                Criteria
              </div>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {selectedFacets.map((facet) => {
                      ...
                      return (
                        <span
                          key={facet.facet_account_id}
                          className="inline-flex items-center gap-1.5 rounded-md border border-primary/30 bg-primary/10 py-1 pr-1.5 pl-2.5 text-[13px] font-medium"
                        >
                          {facet.label}
                          {facetInfo && (
                            <span className="rounded border border-border bg-background px-1.5 py-px text-[10px] uppercase tracking-wider text-muted-foreground">
                              {facetInfo.kindLabel}
                            </span>
                          )}
                          <button
                ...
                {selectedFacets.length < 3 && availableFacets.length > 0 && (
                  ...
                  >
                    <PopoverTrigger asChild>
                      <button
                        type="button"
                        className="flex w-full items-center gap-2 rounded-lg border border-dashed border-border px-3 py-2 text-[13px] text-muted-foreground transition-colors hover:border-primary hover:border-solid hover:text-foreground"
                      >
