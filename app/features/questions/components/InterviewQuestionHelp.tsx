  ...
  const pages = [
    {
      ...
      points: ["Open-ended and conversational", "Specific and focused (one topic)", "Invites stories and concrete examples"],
    },
    {
      title: "Order to ask",
      points: ["Warm-up context → recent experiences", "Dive into pains and workflows", "Wrap with motivations and constraints"],
    },
    {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-xl">
        ...
        <div className="relative">
          <button
            type="button"
            className="absolute left-2 top-1/2 -translate-y-1/2 rounded p-1 hover:bg-accent"
            title="Previous"
