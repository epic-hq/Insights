                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2 text-muted-foreground text-sm">
                    <p>
                      ...
                      Click any cell to edit it directly. Changes save
                      automatically.
                    </p>
                    <p>
                      <strong className="text-foreground">Search:</strong> Use
                      the search box to filter across all columns instantly.
                    </p>
                    <p>
                      <strong className="text-foreground">Sort:</strong> Click
                      column headers to sort ascending or descending.
                    </p>
                    <p>
                      <strong className="text-foreground">Export:</strong>{" "}
                      Download the table as CSV for use in Excel or Google
                      Sheets.
                    </p>
                    <p>
                      <strong className="text-foreground">Chat updates:</strong>{" "}
                      Ask the AI assistant to add rows, update values, or add
                      columns. Example: "Add a row for website URLs to the
                      competitive matrix"
                    </p>
                  </div>
                </div>
            ...
            >
              ...
              <DialogContent className="sm:max-w-[400px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Enter a name for the new column. It will be added to all
                ...
                <DialogFooter>
                  ...
                  <Button
                    ...
                    disabled={
                      !newColumnName.trim() || addColumnFetcher.state !== "idle"
                    }
                  >
                    Add Column
                  </Button>
        ...
        {tableData ? (
          ...
          <div className="rounded-lg border bg-card p-8 text-center">
            <p className="text-muted-foreground">
              No table data available for this asset.
            </p>
          </div>
        )}
      </PageContainer>
