...
const recorderErrorMessages: Record<string, string> = {
  ...
  invalid_media_constraints:
    "Requested microphone constraints are not supported",
...
export function useSpeechToText({
  onTranscription,
}: UseSpeechToTextOptions = {}): SpeechToTextState {
  ...
  useEffect(() => {
    ...
    const friendly =
      recorderErrorMessages[recorderError] || recorderErrorMessages.unknown;
