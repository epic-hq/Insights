...
import { type GmailConnection, getGmailConnection } from "~/lib/integrations/gmail.server";
	...
	return (
		<div>
			...
			<p className="mb-4 text-muted-foreground text-sm">
				Connect your workflow tools to unlock survey distribution, meeting intelligence, and more.
			</p>
...
function ComingSoonCard({ icon, name, description }: { icon: React.ReactNode; name: string; description: string }) {
	return (
		<Card className="border-border/40 border-dashed opacity-60">
			<CardContent className="pt-5">
				<div className="mb-3 flex items-center gap-2">
