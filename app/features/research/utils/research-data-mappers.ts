import type { ResearchAnswersData, ResearchAnswerNode, ResearchQuestionNode } from "~/features/research/components/ResearchAnswers"
 ...
 */
export function getTopResearchQuestions(data: ResearchAnswersData | null, limit = 5): Array<{
  id: string
  text: string
