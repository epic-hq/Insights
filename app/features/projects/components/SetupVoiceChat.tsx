...
import { type VoiceOrbState, VoiceOrb } from "~/components/ui/voice-orb";
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <p className="mb-8 max-w-md text-muted-foreground">
          Have a natural conversation to set up {projectName}. I'll ask you
          about your research goals and target customers.
        </p>
...
function VoiceChatUI({ projectName, onEnd, onComplete }: VoiceChatUIProps) {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      const audioTrack = localParticipant.audioTrackPublications
        .values()
        .next().value;
      if (audioTrack?.track) {
