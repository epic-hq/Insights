...
import { ArrowRight, Building2, Check, FolderKanban, MessageSquare, Pencil, SlidersHorizontal } from "lucide-react";
...
const COMPANY_QUESTIONS = [
	{
		...
		description: "We'll research your company profile and auto-fill as much of your profile as possible.",
...
export default function ProjectSetupPage() {
	const { accountId, projectId, prefill, initialSections, hasCompanyContext, accountData } =
	...
	const FIELD_PROMPTS: Record<string, string> = {
		...
		target_orgs: "Help me set up which organizations I should target for research.",
		...
		research_goal_details: "Help me set up more detail for my research objectives.",
		decision_questions: "Help me set up the key business questions this research should answer.",
		...
		<div className="flex items-center justify-center pt-6">
			<div className="flex items-center gap-1 rounded-lg border bg-muted/50 p-1">
				<button
					...
					className={cn(
						"flex items-center gap-1.5 rounded-md px-3 py-1.5 font-medium text-sm transition-all",
						!isInChatMode ? "bg-background text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"
					)}
				>
		...
		<ProjectSetupProvider projectId={projectId} initialData={initialSections as Record<string, unknown>}>
			<div className="flex min-h-screen flex-col">
				...
				<div className="flex items-center justify-between border-b px-6 py-3">
					<h1 className="font-semibold text-lg">{isWelcomeFlow ? "Tell us about your project" : "Project Context"}</h1>
				</div>
