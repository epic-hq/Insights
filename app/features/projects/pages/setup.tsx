/**
 * Unified Project Setup Page
 *
 * Combines chat and form modes for setting up project context.
 * Both modes share state via ProjectSetupProvider and sync in real-time.
 */
...
import { SetupStepRail } from "~/features/projects/components/SetupStepRail";
import { SyncStatusIndicator } from "~/features/projects/components/SyncStatusIndicator";
import { ProjectSetupProvider } from "~/features/projects/contexts/project-setup-context";
  ...
  return (
    ...
    >
      <div className="flex min-h-screen">
        ...
        <SetupStepRail className="hidden lg:block" />
        ...
        <div className="flex-1">
          ...
          >
            {/* Header with Mode Toggle and Method Settings */}
            <div className="mb-6 flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 flex items-center gap-3 text-muted-foreground text-sm">
                  <span>
                    {mode === "chat"
                      ? "Chat with me to set up your project context."
                      : "Fill out the form — it syncs with chat."}
                  </span>
                  <SyncStatusIndicator />
                </p>
              </div>
              <div className="flex items-center gap-3">
                {/* Method Settings - opens modal for public link config */}
            ...
            <div id="setup-content" role="tabpanel">
              {mode === "chat" ? (
                <ProjectSetupChat
                  accountId={accountId}
                  projectId={projectId}
