...
function SetupCapturedPane({
	...
	const capturedFields: CapturedField[] = CAPTURED_FIELD_DEFINITIONS.map((fieldDef) => {
		...
		if (localValue && (Array.isArray(localValue) ? localValue.length > 0 : localValue)) {
			value = localValue
	...
	return <CapturedPane fields={capturedFields} onAskAboutField={onAskAboutField} onEditField={onEditField} />
}
...
const PROJECT_QUESTIONS = [
	...
	},
	{
		...
		description: "Help us understand your situation better - challenges, constraints, timeline, etc.",
		fieldType: "textarea" as const,
		required: false,
		showSTT: true,
	},
