			...
			<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
				...
				<Card className="mt-6">
					<CardHeader>
						...
						<CardDescription>Control how AI analyzes and groups insights from interviews</CardDescription>
					</CardHeader>
					<CardContent>
						<form method="post" className="space-y-6">
							<input type="hidden" name="intent" value="update_analysis_settings" />
							...
							<div className="space-y-4">
								<div className="space-y-3">
									<div className="flex items-center justify-between">
										...
										<span className="text-muted-foreground text-sm">{Math.round(themeDedupThreshold * 100)}%</span>
									</div>
									<Slider
										id="theme-dedup"
										min={50}
									...
									<p className="text-muted-foreground text-xs">
										How similar two themes must be to merge them. Higher = more themes, lower = more consolidation.
									</p>
								</div>
								...
								<div className="space-y-3">
									<div className="flex items-center justify-between">
										...
										<span className="text-muted-foreground text-sm">{Math.round(evidenceLinkThreshold * 100)}%</span>
									</div>
									<Slider
										id="evidence-link"
										min={20}
									...
									/>
									<p className="text-muted-foreground text-xs">
										How similar evidence must be to link to a theme. Higher = fewer but more relevant links.
									</p>
								</div>
							</div>
