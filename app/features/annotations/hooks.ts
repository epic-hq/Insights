...
export function useEntityAnnotations({
  ...
  return {
    ...
    submitAnnotation: includeComments
      ? (content: string, contentJsonb?: Record<string, unknown>) =>
          annotationsHook.addComment(content, contentJsonb)
      : () => {},
    ...
    userVote: includeVoting
      ? { vote_value: votingHook.voteCounts.user_vote }
      : null,
