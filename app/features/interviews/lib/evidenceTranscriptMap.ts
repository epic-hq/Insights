 ...
 */
function parseAnchorTime(raw: number | string | null | undefined): number | null {
 ...
 */
export function extractEvidenceTimeRange(evidenceId: string, anchors: unknown): EvidenceTimeRange | null {
 ...
 */
export function findOverlappingUtterances(range: EvidenceTimeRange, utterances: NormalizedUtterance[]): number[] {
 ...
 */
export function findBestUtteranceIndex(range: EvidenceTimeRange, utterances: NormalizedUtterance[]): number {
