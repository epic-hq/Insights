...
export function LensSwitcher({
  ...
  const activeLensKey =
    selectedLensKey ??
    completedTemplates[0]?.template_key ??
    sortedTemplates[0]?.template_key;

  const activeTemplate = sortedTemplates.find(
    (t) => t.template_key === activeLensKey,
  );
      ...
      <div className="space-y-4">
        <div className="rounded-lg border border-dashed p-6 text-center">
          ...
          <p className="mb-4 text-muted-foreground text-sm">
            No lens analyses have been run yet
          </p>
          <LensSelector
          ...
          <DropdownMenuTrigger asChild>
            <Button variant="outline" size="sm" className="gap-2">
              ...
              <span className="font-medium">
                {activeTemplate?.template_name ?? "Select lens"}
              </span>
        ...
        {activeTemplate && activeAnalysis?.status === "completed" && (
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                Re-analyze with {activeTemplate.template_name}
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        )}
