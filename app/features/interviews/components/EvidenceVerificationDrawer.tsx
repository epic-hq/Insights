						...
						<div className="space-y-0">
							...
							<div className="border-border border-b bg-muted/20 p-4">
								<div className="space-y-2">
									{signedThumbUrl && (
										<img src={signedThumbUrl} alt="" className="h-20 w-36 rounded-md object-cover" loading="lazy" />
									)}
											...
											<div className="flex items-center gap-1">
												<Tooltip>
													<TooltipTrigger asChild>
														<Button
															variant={voteCounts.user_vote === 1 ? "default" : "outline"}
															size="sm"
															className="h-7 gap-1 px-2 text-xs"
															onClick={() => (voteCounts.user_vote === 1 ? removeVote() : upvote())}
														>
															<ThumbsUp className={cn("h-3 w-3", voteCounts.user_vote === 1 && "fill-current")} />
												...
												<Tooltip>
													<TooltipTrigger asChild>
														<Button
															variant={voteCounts.user_vote === -1 ? "destructive" : "outline"}
															size="sm"
															className="h-7 gap-1 px-2 text-xs"
															onClick={() => (voteCounts.user_vote === -1 ? removeVote() : downvote())}
														>
															<ThumbsDown className={cn("h-3 w-3", voteCounts.user_vote === -1 && "fill-current")} />
												...
												<Tooltip>
													<TooltipTrigger asChild>
														...
														>
															<Star className={cn("h-3 w-3", flags.starred && "fill-yellow-400 text-yellow-400")} />
														</Button>
													</TooltipTrigger>
													<TooltipContent>{flags.starred ? "Unstar" : "Star"}</TooltipContent>
												</Tooltip>
												<Tooltip>
													<TooltipTrigger asChild>
														<Button
														...
														>
															<Archive className={cn("h-3 w-3", flags.archived && "text-orange-500")} />
														</Button>
													</TooltipTrigger>
													<TooltipContent>{flags.archived ? "Unarchive" : "Archive"}</TooltipContent>
												</Tooltip>
												<Tooltip>
													<TooltipTrigger asChild>
														<Button
