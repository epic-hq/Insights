  ...
  const loadTranscript = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/a/${currentProject.accountId}/${projectId}/api/interview-transcript?${params}`,
      );
      ...
      const processedData: TranscriptData = {
        ...
        utterances: normalizeTranscriptUtterances(
        ...
        sentiment_analysis_results:
          data.transcript_formatted?.sentiment_analysis_results,
