					...
					<div className="flex flex-col gap-6">
						<div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
							...
							<div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center sm:justify-end">
								<Button variant="outline" className="w-full text-sm sm:w-auto" onClick={() => setNoteDialogOpen(true)}>
				...
				{sourceTab === "files" ? (
								...
								<Popover>
									...
									<PopoverContent className="w-120 bg-accent text-foreground" align="end" sideOffset={8}>
										...
										<ul className="space-y-1">
											...
											<li>
												• <strong>Edit inline</strong> — Click any file to view and edit the data directly and it
												becomes immediately usably by Uppy
											</li>
										</ul>
									</PopoverContent>
								</Popover>
					...
					<div className="py-16 text-center">
						<div className="mx-auto max-w-md">
							...
							<h3 className="mb-3 font-semibold text-gray-900 text-xl dark:text-white">No notes yet</h3>
							<p className="mb-8 text-gray-600 dark:text-gray-400">
