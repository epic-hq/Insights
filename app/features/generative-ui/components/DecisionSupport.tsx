/**
 * DecisionSupport - Action-oriented decision widget for chat
 *
 * Presents prioritized actions with effort/impact assessment, supporting evidence,
 * and tradeoff analysis. Helps teams move from research to committed decisions.
 */
...
export function DecisionSupport({ data, isStreaming, onAction }: DecisionSupportProps) {
	return (
			...
			{(data.narrative || data.actionsUrl) && (
				<div className="border-t px-5 py-4">
					...
					{data.actionsUrl && (
						<Link
							to={data.actionsUrl}
							onClick={() => onAction?.("saveActions", { actionsUrl: data.actionsUrl })}
