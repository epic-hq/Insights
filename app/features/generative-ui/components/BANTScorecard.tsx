  ...
  return (
    <Card
      className={cn(
        ...
        facet.updating && "ring-2 ring-primary/50",
      )}
    >
      {facet.updating && (
    ...
    <div className="space-y-4">
      ...
      <Card className="border-2">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="text-center">
                ...
                <div
                  className={cn(
                    "mt-1 flex items-center gap-1 font-medium text-sm",
                    temperature.color,
                  )}
                >
        ...
        <CardContent>
          ...
          {isStreaming && (
            <p className="mt-2 animate-pulse text-muted-foreground text-xs">
              Extracting evidence from conversation...
            </p>
          )}
        </CardContent>
      </Card>
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              ...
              <p className="mt-1 text-emerald-700 text-xs dark:text-emerald-300">
                Strong qualification signals across all BANT criteria. Consider
                scheduling a proposal review or demo.
              </p>
            </div>
          </div>
        </motion.div>
