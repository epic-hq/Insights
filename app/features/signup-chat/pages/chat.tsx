...
function transformProjectSectionsToSuggestions(
  ...
  return projectSections.slice(0, 5).map((section, index) => ({
    ...
    description:
      section.content || "AI-generated recommendation based on your data.",
...
export function MobileInsightsApp() {
  ...
  const [aiSuggestions] = useState(() =>
    transformProjectSectionsToSuggestions(loaderData?.projectSections || []),
  );
  ...
  const [researchConfig, setResearchConfig] = useState({
    ...
    backgroundKnowledge:
      "E-commerce platform with 2M monthly users, 65% mobile traffic, current conversion rate 2.3%",
  });

  const [painPointsState, setPainPointsState] =
    useState<PainPoint[]>(painPoints);
  ...
  const _captureQuestions = [
    ...
    },
    {
      key: "firstStep",
      question:
        "If a guide appeared, what first step would you want from them?",
    },
  ];
  ...
  return (
    <CopilotSidebar>
      <div className="flex bg-gray-50">
                  ...
                  <CardContent className="p-3">
                    ...
                    <div className="relative z-10">
                      <div className="mb-2 flex items-start justify-between">
                        <h3 className="line-clamp-2 flex-1 pr-2 font-medium text-gray-900 text-sm">
                          {pain.name}
                        </h3>
        ...
        <Dialog
          open={!!selectedPain}
          onOpenChange={() => setSelectedPain(null)}
        >
          <DialogContent className="max-w-md">
            {selectedPain && (
              <>
                  ...
                  <div className="rounded-lg bg-gray-50 p-4">
                    <div className="mb-3 flex items-center gap-3">
                      <span className="text-2xl">
                        {selectedPain.emotionEmoji}
                      </span>
                      <div>
                        <Badge className={selectedPain.emotionColor}>
                          {selectedPain.emotion}
                        </Badge>
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        {selectedPain.annotations.map((annotation) => (
                          <p
                            key={annotation}
                            className="rounded bg-yellow-50 p-2 text-gray-600 text-sm"
                          >
                            {annotation}
                          </p>
                        ))}
          ...
          <DialogContent className="mx-auto max-w-sm">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-3 gap-2">
                <Button
                  variant="outline"
                  className="flex h-20 flex-col gap-2 bg-transparent"
                >
