			...
			<div className="mx-auto max-w-5xl px-4 py-10">
				...
				<Card className="mb-6">
					<CardHeader className="pb-3">
						<CardTitle className="font-medium text-base">Company Details</CardTitle>
					...
					<CardContent>
						<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
							...
							{/* Industry */}
							<div className="space-y-1">
								<label className="font-medium text-muted-foreground text-xs">Industry</label>
								<InlineEditableField
									entityId={organization.id}
									entityIdKey="organizationId"
									field="industry"
							...
							{/* Company Type */}
							<div className="space-y-1">
								<label className="font-medium text-muted-foreground text-xs">Company Type</label>
								<InlineEditableField
									entityId={organization.id}
									entityIdKey="organizationId"
									field="company_type"
						...
						<div className="mt-4 space-y-1 border-t pt-4">
							<label className="font-medium text-muted-foreground text-xs">Description</label>
							<InlineEditableField
								entityId={organization.id}
								entityIdKey="organizationId"
								field="description"
									...
									<div className="flex items-center gap-3">
										...
										<div>
											<h3 className="font-semibold text-sm">
												{isResearching ? "Researching..." : "Auto-fill with AI Research"}
											</h3>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							...
							{opportunities.length === 1 ? "y" : "ies"} associated with this organization
						</CardDescription>
					</CardHeader>
					<CardContent>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							...
							{conversations.length !== 1 ? "s" : ""} with people from this organization
						</CardDescription>
					</CardHeader>
					<CardContent>
