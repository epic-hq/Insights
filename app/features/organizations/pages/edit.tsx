			...
			<Form method="post" className="space-y-6">
				...
				<div className="rounded-lg border bg-gradient-to-r from-violet-500/5 via-purple-500/5 to-fuchsia-500/5 p-4">
					<div className="mb-3 flex items-center gap-2">
						<span className="font-medium text-foreground text-sm">Essential Info</span>
						<span className="rounded-full bg-violet-100 px-2 py-0.5 font-medium text-[10px] text-violet-700 dark:bg-violet-900/50 dark:text-violet-300">
					...
					<div className="grid gap-4 md:grid-cols-2">
						...
						<div>
							<Label htmlFor="website_url" className="flex items-center gap-2">
								Website
								<span className="text-[10px] text-muted-foreground">(enables AI auto-fill)</span>
							</Label>
							<Input
								id="website_url"
								name="website_url"
