  ...
  return (
    <div className="container mx-auto space-y-6 py-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Detect and fix interviews stuck in processing
          </p>
        </div>
        <Button
          variant="outline"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {stuckCount > 0 ? (
              <>
                Found {stuckCount} interview{stuckCount !== 1 ? "s" : ""} that
                may be stuck. Click "Fix All" to restart processing.
              </>
            ) : (
              <>
                All interviews are processing normally. Auto-refreshing every 30
                seconds.
              </>
            )}
          </CardDescription>
      ...
      {fetcher.data && (
        <Card
          className={
            fetcher.data.success ? "border-green-500" : "border-destructive"
          }
        >
          <CardContent className="pt-6">
            <p
              className={
                fetcher.data.success ? "text-green-600" : "text-destructive"
              }
            >
      ...
      {stuckCount > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Interviews that are stuck in processing without active Trigger.dev
              tasks
            </CardDescription>
          </CardHeader>
          <CardContent>
