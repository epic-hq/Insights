...
import { Archive, Check, Clock, Edit2, ThumbsDown, ThumbsUp } from "lucide-react";
			...
			<PageContainer size="sm" padded={false} className="max-w-2xl">
				...
				{isEditing && (
					<div className="mb-4 space-y-3 rounded-lg border border-border border-dashed bg-muted/30 p-4">
						...
						<div className="grid grid-cols-2 gap-3">
							<EditableField label="Support" fieldName="support" value={selectedEvidence.support} onSave={saveField} />
							<EditableField
								label="Confidence"
