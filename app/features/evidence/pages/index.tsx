          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="flex flex-wrap gap-1.5">
              <Button
                ...
                onClick={() =>
                  updateParam("facet_kind", facetKind === "goal" ? "" : "goal")
                }
              >
              ...
              <Button
                ...
                onClick={() =>
                  updateParam("facet_kind", facetKind === "gain" ? "" : "gain")
                }
              >
              ...
              <Button
                ...
                className={cn(
                  "h-7 gap-1 px-2 text-xs",
                  facetKind === "pain" &&
                    "border-rose-800 bg-rose-950/50 text-rose-200 hover:bg-rose-950/70",
                )}
                onClick={() =>
                  updateParam("facet_kind", facetKind === "pain" ? "" : "pain")
                }
              >
