  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "flex flex-col",
          variant === "mini" ? "space-y-2 p-3" : "space-y-3 p-4",
        )}
      >
        {/* Gist - Headline */}
        <h3
            ...
            <div className="flex flex-wrap gap-2 text-xs">
              ...
              {evidence.method && (
                <Badge variant="outline" className="gap-1">
                  ...
                  {evidence.method.charAt(0).toUpperCase() +
                    evidence.method.slice(1)}
                </Badge>
              )}
              ...
              {evidence.confidence === "high" && (
                <Badge
                  variant="outline"
                  className="gap-1 border-green-700 bg-green-950/30 text-green-300"
                >
