    ...
    async (id: string) => {
      ...
      try {
        const response = await fetch(
          `${currentProject.projectPath}/api/evidence/${id}`,
          { credentials: "include" },
        );
        if (!response.ok) {
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        userVote === -1 ? removeVote() : downvote()
                      }
                      className="gap-1.5"
                    >
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        This will remove this evidence from all views and
                        analysis. You can recover it from Recently Deleted
                        within 30 days.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
