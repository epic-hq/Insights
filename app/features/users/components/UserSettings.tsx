...
function Row({ label, value }: { label: string; value: React.ReactNode }) {
  return (
    <div className="grid grid-cols-3 gap-3 py-2">
      <div className="col-span-1 font-medium text-gray-600 text-sm">
        {label}
      </div>
...
function UserSettings({
  ...
  if (!settings.title) missingFields.push("job title");
  if (!settings.job_function) missingFields.push("job function");
      ...
      <div className="mt-6 rounded-xl border bg-white p-4 shadow-sm">
        ...
        <div className="divide-y">
          <EditableRow
            ...
            placeholder="e.g., VP of Product, Senior Designer"
          />
          <EditableRow
            label="Job Function"
            field="job_function"
            value={settings.job_function}
            placeholder="e.g., Product, Engineering, Sales, Design"
          />
          <EditableRow
            label="Industry"
            field="industry"
