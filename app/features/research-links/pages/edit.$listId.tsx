			...
			<Form method="post" className="space-y-4">
				...
				<div className="grid gap-6 lg:grid-cols-[minmax(0,400px),minmax(240px,280px)]">
					<div className="min-w-0 space-y-4">
						...
						<div className="space-y-1.5">
							<h3 className="font-medium text-foreground/80 text-sm">Email Distribution</h3>
							<Card>
									...
									{gmailConnected ? (
										<div className="flex items-center gap-3">
											...
											<div className="flex-1">
												<p className="font-medium text-sm">
													Gmail connected
													{gmailEmail && <span className="ml-1 font-normal text-muted-foreground">({gmailEmail})</span>}
												</p>
										...
										<div className="flex items-center justify-between gap-3">
											<div className="flex items-center gap-3">
												...
												<div>
													<p className="font-medium text-sm">Send via email — one step away</p>
