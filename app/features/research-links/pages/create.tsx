                ...
                <CardContent className="p-8">
                  <div className="text-center">
                    ...
                    <p className="mx-auto mb-8 max-w-sm text-muted-foreground">
                      Just tell me what you're looking for and I'll create the
                      survey, even with branches and questions for special
                      groups
                    </p>
                      ...
                      {isGeneratingFromVoice ? (
                        ...
                        <div className="flex flex-col items-center gap-4">
                          ...
                          >
                            ...
                            <div className="relative flex h-full w-full items-center justify-center rounded-full bg-primary shadow-lg transition-all group-hover:shadow-xl group-hover:shadow-primary/25">
