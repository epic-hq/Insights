...
import { ArrowLeft, ArrowRight, Check, ClipboardList, Copy, Loader2, Plus, Sparkles, X } from "lucide-react"
...
export async function loader({ params, request }: LoaderFunctionArgs) {
	...
	// Fetch interview prompts to allow seeding questions
...
export default function CreateResearchLinkPage() {
	const { accountId, projectId, interviewPrompts } = useLoaderData<typeof loader>()
								...
								<div className="mb-6 flex items-start justify-between gap-4">
									...
									<div className="flex shrink-0 gap-2">
										{interviewPrompts.length > 0 && (
											<Button type="button" variant="outline" size="sm" onClick={handleImportPrompts} className="gap-2">
