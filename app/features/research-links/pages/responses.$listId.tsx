						...
						<>
							<div className="flex items-center justify-between">
								...
								<div className="flex gap-2">
									...
									<Button variant="ghost" size="sm" onClick={() => openBreakdownModal(0)}>
										<Maximize2 className="mr-2 h-4 w-4" />
										Full screen
									</Button>
								</div>
									...
									<>
										...
										<div className="h-[70vh] overflow-y-auto pr-1 sm:pr-2">
											<QuestionBreakdown
												...
												showDivider={false}
												hideHeader
												aiInsight={getQuestionInsight(activeBreakdown.questionText, activeQuestionIndex)}
											/>
								...
								<div className="flex flex-col gap-4">
									...
									<div className="h-[50vh] space-y-3 overflow-y-auto pr-1 sm:pr-2">
										...
										{activeThemeForCard && (
											<div className="space-y-3">
												<div className="space-y-1">
													<h3 className="font-semibold text-lg">{activeThemeForCard.theme}</h3>
													<p className="text-muted-foreground text-sm">{activeThemeForCard.description}</p>
												</div>
