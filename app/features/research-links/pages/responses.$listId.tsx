							...
							<div className="flex flex-col gap-3 sm:gap-4">
								...
								{isOnVideoCard ? (
									<>
										...
										<div className="h-[50vh] overflow-y-auto pr-1 sm:h-[55vh] sm:pr-2">
									...
									<>
										...
										{/* Content first, navigation at bottom */}
										<div className="h-[50vh] overflow-y-auto pr-1 sm:h-[55vh] sm:pr-2">
											<QuestionBreakdown
									...
									<div className="flex items-center gap-1.5">
										{questionStats.map((_, idx) => (
											<button
												...
												className={`flex h-6 w-6 items-center justify-center rounded-full font-medium text-xs transition-all ${idx === activeQuestionIndex
										...
										{hasVideoCard && (
											<button
												...
												className={`flex h-6 w-6 items-center justify-center rounded-full font-medium text-xs transition-all ${isOnVideoCard
														? "bg-primary text-primary-foreground ring-2 ring-primary/30"
														: "bg-muted text-muted-foreground hover:bg-muted-foreground/20"
													}`}
												...
												{Array.from({ length: analysisCardCount }).map(
													(_, idx) => (
														<button
															...
															className={`flex h-6 w-6 items-center justify-center rounded-full font-medium text-xs transition-all ${idx === activeAnalysisCard
																	? "bg-primary text-primary-foreground ring-2 ring-primary/30"
																	: "bg-muted text-muted-foreground hover:bg-muted-foreground/20"
																}`}
															aria-label={
											...
											<div className="flex items-center gap-1.5">
												{videoResponses.map((_, idx) => (
													<button
														...
														className={`flex h-6 w-6 items-center justify-center rounded-full font-medium text-xs transition-all ${idx === activeVideoIndex
																? "bg-primary text-primary-foreground ring-2 ring-primary/30"
																: "bg-muted text-muted-foreground hover:bg-muted-foreground/20"
															}`}
