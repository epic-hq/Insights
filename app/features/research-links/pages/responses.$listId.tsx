      ...
      {aiInsight && (
        <div className="mt-4 space-y-3 rounded-lg border border-primary/20 bg-primary/5 p-4">
          ...
          {aiInsight.key_findings.length > 0 && (
            <div>
              <h5 className="mb-1 font-medium text-xs text-muted-foreground">
                Key Findings
              </h5>
    ...
    <PageContainer className="space-y-6">
      ...
      {responses.length === 0 ? (
        ...
        <>
          ...
          >
            <DialogContent className="sm:max-w-6xl max-w-[calc(100%-1.5rem)] max-h-[92vh] overflow-hidden">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex items-center justify-between gap-3 rounded-md border bg-muted/50 px-3 py-2">
                    ...
                    <div className="flex flex-1 flex-col items-center gap-1 text-center">
                      ...
                      <div className="line-clamp-2 font-semibold text-base">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button
                        ...
                        disabled={
                          activeQuestionIndex >= questionStats.length - 1
                        }
                  ...
                  <div className="h-[60vh] overflow-y-auto pr-1 sm:pr-2">
                    <QuestionBreakdown
