...
export const ResearchLinkQuestionSchema = z.object({
  ...
  type: z
    .enum(["auto", "short_text", "long_text", "single_select", "multi_select"])
    .default("auto"),
...
const QuestionsJsonSchema = z
  ...
  .pipe(
    z.array(ResearchLinkQuestionSchema).min(1, "Add at least one question"),
  );
...
export type ResearchLinkResponsePayload = z.infer<
  typeof ResearchLinkResponseSaveSchema
>;
