			...
			<div className="grid gap-4 sm:grid-cols-2">
				...
				<div className="space-y-2 sm:col-span-2">
					...
					<p className="text-muted-foreground text-xs">
						Email clients can’t play video. Use a thumbnail or GIF that links to your survey. If you leave this empty,
						the HTML uses a placeholder you should replace.
					</p>
				</div>
				...
				<CardContent className="min-w-0 overflow-hidden">
					<Tabs defaultValue="html" className="w-full min-w-0 overflow-hidden">
						...
						<TabsContent value="email" className="min-w-0 space-y-2">
							<p className="text-muted-foreground text-xs">
								Email clients block video and embeds. Use a thumbnail image that links to your survey.
							</p>
							<div className="rounded-lg border bg-background p-3">
								<p className="text-[11px] text-muted-foreground uppercase tracking-wide">Email preview</p>
								...
								<div className="mt-3 text-center">
									<p className="font-medium text-foreground text-sm">{emailPreviewHeadline}</p>
									<div className="mt-2 inline-flex rounded-md bg-foreground px-3 py-1.5 font-medium text-[11px] text-background">
										{emailPreviewButtonLabel}
									</div>
									<p className="mt-2 text-muted-foreground text-xs">Watch the video + respond:</p>
									<p className="font-medium text-[11px] text-foreground">Open the video survey</p>
