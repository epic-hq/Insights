...
const LAYOUT_OPTIONS: { value: EmbedLayout; label: string; description: string }[] = [
	{
		value: "compact",
		label: "Compact",
		...
		<div className="space-y-4">
			...
			<div className="grid gap-4 sm:grid-cols-2">
				<div className="space-y-2">
					...
					<Select value={config.theme} onValueChange={(v) => setConfig((prev) => ({ ...prev, theme: v as EmbedTheme }))}>
