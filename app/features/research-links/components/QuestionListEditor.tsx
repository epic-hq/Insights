						...
						<div className="space-y-3">
							...
							<label className="flex cursor-pointer items-center gap-2 rounded-md border border-border/50 bg-muted/20 px-3 py-2">
								...
								<div>
									...
									<p className="text-muted-foreground text-xs">Show a write-in text field for custom responses</p>
								</div>
							</label>
						</div>
					)}
							...
							>
								...
								<span
									className={cn(
										...
										question.prompt ? "text-foreground" : "text-muted-foreground italic"
									)}
								>
								...
								<div className="flex shrink-0 items-center gap-1.5">
									...
									{question.allowOther && <FileText className="h-3.5 w-3.5 text-amber-500" />}
								</div>
							</button>
						</motion.div>
					);
