...
export function SurveyQuickView({
  ...
  const startEditing = useCallback(
    (questionId: string, currentText: string) => {
      ...
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center gap-3 py-3 border-b">
          ...
          <div className="flex-1 min-w-0">
            <p className="font-medium truncate">{currentSurvey.personName}</p>
          ...
          <div className="flex items-center gap-2">
            <Badge
              ...
              className={cn(
                "text-xs",
                goalColors[currentSurvey.surveyGoal] || "",
              )}
            >
                  ...
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <Button
                        ...
                        className="h-6 w-6"
                        onClick={() =>
                          startEditing(question.id, question.prompt)
                        }
                      >
        ...
        <div className="flex items-center justify-between pt-3 border-t">
          ...
          <div className="flex gap-2">
            <Button variant="ghost" size="sm" onClick={handleSkip}>
              ...
              Skip
              <kbd className="ml-1 text-[10px] border rounded px-1 text-muted-foreground">
                S
              </kbd>
            </Button>
            <Button size="sm" onClick={handleApprove}>
              ...
              Approve
              <kbd className="ml-1 text-[10px] border rounded px-1 bg-primary-foreground/10">
                Space
              </kbd>
            </Button>
          </div>
