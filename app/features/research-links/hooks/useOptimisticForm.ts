...
export function useOptimisticForm(
  ...
  /** Update questions: saves immediately unless a question has an empty prompt
   *  (e.g. just added). In that case, mark dirty but wait for user to fill it in. */
