          ...
          <div className="container px-4 text-center md:px-6">
            <div className="space-y-6">
              ...
              <h1 className="font-bold text-4xl tracking-tight sm:text-5xl md:text-6xl lg:text-7xl/none">
                The only research platform that coaches your team, uncovers
                wedge opportunities, and delivers executive-ready insights
              </h1>
              <p className="mx-auto max-w-[800px] text-lg md:text-xl/relaxed">
                Turn everyday conversations into strategic decisions. From
                framing better questions to automated persona analysis, UpSight
                makes research effortless, rigorous, and actionable for everyone
                on your team.
              </p>
              <div className="flex flex-col gap-4 sm:flex-row sm:justify-center sm:gap-6">
                <Button
                  asChild
                  className="bg-white px-8 py-4 font-semibold text-blue-600 text-lg hover:bg-gray-100"
                >
              ...
              <p className="text-sm text-white/80">
                ✓ 100% traceable evidence &nbsp;&nbsp; ✓ Real-time insights
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="font-bold text-3xl tracking-tighter sm:text-5xl">
                  While others turn your team into researchers, we turn your
                  conversations into strategic advantages
                </h2>
                <p className="max-w-[900px] text-gray-600 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Built for customer-facing teams who need insights, not
                  research degrees.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-6xl items-start gap-8 py-12 sm:grid-cols-2 lg:grid-cols-4">
              <Card className="flex h-full flex-col items-center p-6 text-center">
                <div className="flex flex-1 flex-col items-center">
                  ...
                  <h3 className="mb-3 font-semibold text-lg">
                    Smart Research Strategy Coach
                  </h3>
                  <p className="text-gray-600 text-sm">
                    Guides framing of right questions to reduce bias. Strategic
                    guidance before research even starts, not just analysis
                    after.
                  </p>
                </div>
              </Card>
              <Card className="flex h-full flex-col items-center p-6 text-center">
                <div className="flex flex-1 flex-col items-center">
                  ...
                  <h3 className="mb-3 font-semibold text-lg">
                    Automated Persona & Theme Generation
                  </h3>
                  <p className="text-gray-600 text-sm">
                    Persona-theme analysis to find wedge opportunities & core
                    concerns. Direct path to opportunity discovery.
                  </p>
                </div>
              </Card>
              <Card className="flex h-full flex-col items-center p-6 text-center">
                <div className="flex flex-1 flex-col items-center">
                  ...
                  <h3 className="mb-3 font-semibold text-lg">
                    Evidence Traceability & Trust
                  </h3>
                  <p className="text-gray-600 text-sm">
                    100% traceable evidence sources. Links every insight to real
                    evidence for total traceability and trust.
                  </p>
                </div>
              </Card>
              <Card className="flex h-full flex-col items-center p-6 text-center">
                <div className="flex flex-1 flex-col items-center">
                  ...
                  <p className="text-gray-600 text-sm">
                    Works in real time, so you can act while conversations are
                    happening. Realtime insights vs static reports.
                  </p>
                </div>
              </Card>
            </div>
            ...
            <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
              <div className="space-y-6">
                ...
                <p className="text-gray-600 md:text-xl/relaxed">
                  UpSight transforms your everyday customer conversations into
                  decision-ready insights with complete traceability.
                </p>
                  ...
                  <li>
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">
                          AI guides you to ask better questions that reduce bias
                          and uncover real insights before you even start.
                        </p>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">
                          Real-time persona mapping and theme identification
                          from your conversations with 100% traceable evidence.
                        </p>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">
                          Get wedge opportunities and executive summaries that
                          travel well and drive immediate action.
                        </p>
                      </div>
                    </div>
                  </li>
          ...
          <div className="container px-4 md:px-6">
            <div className="mx-auto max-w-4xl text-center">
              <div className="space-y-4">
                ...
                <h2 className="font-bold text-3xl tracking-tighter sm:text-4xl md:text-5xl">
                  Your team already has customer relationships. Why make
                  research harder than it needs to be?
                </h2>
              </div>
              <div className="mx-auto mt-12 grid max-w-5xl gap-8 sm:grid-cols-2 lg:grid-cols-3">
                <Card className="p-6 text-left">
                  ...
                  <p className="text-gray-600 text-sm">
                    "We're making product bets without knowing which customer
                    needs really matter"
                  </p>
                </Card>
                <Card className="p-6 text-left">
                  ...
                  <p className="text-gray-600 text-sm">
                    "We talk to a few people, but it's hard to know if we're
                    hearing the truth or just what we want to hear"
                  </p>
                </Card>
                <Card className="p-6 text-left">
                  <h3 className="mb-3 font-semibold text-lg text-red-600">
                  ...
                  <p className="text-gray-600 text-sm">
                    "Notes, calls, transcripts, sticky docs — all scattered and
                    unusable when we need them"
                  </p>
                </Card>
                <Card className="p-6 text-left">
                  <h3 className="mb-3 font-semibold text-lg text-red-600">
                    Research Feels Too Hard
                  </h3>
                  <p className="text-gray-600 text-sm">
                    "We're not researchers, but we need research-quality clarity
                    to survive"
                  </p>
                </Card>
                <Card className="p-6 text-left">
                  ...
                  <p className="text-gray-600 text-sm">
                    "By the time we turn conversations into slides, the moment
                    (and urgency) is already gone"
                  </p>
                </Card>
                <Card className="p-6 text-left">
                  <h3 className="mb-3 font-semibold text-lg text-red-600">
                  ...
                  <p className="text-gray-600 text-sm">
                    "We're expected to show evidence of customer insight, but we
                    don't have time to synthesize it all"
                  </p>
                </Card>
              </div>
            </div>
        ...
        <section className="w-full bg-gradient-to-r from-blue-600 to-indigo-700 py-12 text-center text-white md:py-24 lg:py-32">
          <div className="container space-y-6 px-4 md:px-6">
            ...
            <p className="mx-auto max-w-[800px] text-lg md:text-xl">
              Join forward-thinking teams who are already making faster, more
              confident decisions with UpSight.
            </p>
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center sm:gap-6">
              <Button
                asChild
                className="bg-white px-10 py-4 font-semibold text-blue-600 text-xl hover:bg-gray-100"
              >
                <Link to={PATHS.AUTH.REGISTER}>Start Free Trial</Link>
              </Button>
              <Button
