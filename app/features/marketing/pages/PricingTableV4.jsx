...
const PricingTable = () => {
  ...
  const featureDisplayName = highlightFeature
    ? FEATURE_DISPLAY_NAMES[highlightFeature] || highlightFeature
    : null;
    ...
    >
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-16 text-center">
          <p className="mb-4 font-medium text-amber-500 text-sm uppercase tracking-widest">
            Pricing
          </p>
        ...
        <div className="mb-12 flex items-center justify-center gap-4">
          ...
          <span className="rounded-full bg-amber-500/10 px-3 py-1 font-semibold text-amber-500 text-xs">
            Save 20%
          </span>
        </div>
            ...
            <div className="rounded-xl border border-amber-500/30 bg-amber-500/5 px-6 py-4 text-center">
              <p className="text-sm text-stone-300">
                ...
                <span className="font-semibold text-stone-100">
                  {highlightPlan.charAt(0).toUpperCase() +
                    highlightPlan.slice(1)}
                </span>{" "}
                or higher
              </p>
            </div>
              ...
              >
                ...
                >
                  ...
                  <div className="mb-4">
                    ...
                    <p className="font-medium text-amber-500/80 text-sm">
                      {plan.subtitle}
                    </p>
                  </div>
                  ...
                  {/* Description */}
                  <p className="mb-5 text-sm text-stone-400 leading-relaxed">
                    {plan.description}
                  </p>
                  ...
                  <a
                    ...
                    {...(plan.ctaExternal
                      ...
                      : {})}
                    className={`mb-6 block w-full rounded-lg px-4 py-3 text-center font-semibold text-sm transition-all duration-200 ${
                        ...
                        <ul className="space-y-2">
                          {section.features.map((feature, fIdx) => (
                            ...
                            >
                              ...
                              <span
                                className={`text-sm ${feature.included ? "text-stone-300" : "text-stone-600"}`}
                              >
                                {feature.name}
                  ...
                  {/* Note */}
                  {plan.note && (
                    <p className="mt-5 border-stone-800/50 border-t pt-4 text-stone-600 text-xs">
                      {plan.note}
                    </p>
                  )}
                </div>
        ...
        <div className="border-stone-800 border-t pt-16">
          <h2 className="mb-12 text-center font-serif text-3xl">
            Why teams choose{" "}
            <span className="text-amber-500 italic">UpSight</span>
          </h2>
