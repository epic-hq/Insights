...
export const meta: MetaFunction = () => {
	return [
		...
		{ property: "og:title", content: "Pricing | UpSight" },
		{
			...
			content: "14 days of full access, no credit card. See what UpSight does for your discovery process.",
		},
...
const faqItems = [
	...
	},
	{
		...
		answer: "No. Start your trial instantly. We only ask for payment when you choose a paid plan.",
	},
	{
	...
	},
	{
		...
		answer: "Anytime. Upgrade, downgrade, or cancel with no lock-in. Changes take effect at your next billing cycle.",
	},
];
		...
		<div className="min-h-screen bg-background">
			...
			<section className="border-b bg-gradient-to-b from-zinc-950 via-zinc-900 to-zinc-800 px-6 py-24 text-white md:py-32">
				<div className="mx-auto max-w-4xl text-center">
					...
					<p className="mx-auto mt-8 max-w-2xl text-lg text-zinc-300 leading-relaxed sm:text-xl md:text-2xl">
						{user
				...
				<div className="mx-auto max-w-4xl">
					<div className="text-center">
						...
						<p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
							Every plan includes unlimited recording and transcription. We'll never charge you to capture
							conversations.
						</p>
					</div>
				...
				<div className="mx-auto max-w-5xl">
					<div className="grid gap-8 md:grid-cols-3">
						...
						<div className="rounded-2xl border bg-card p-8">
							<p className="font-medium text-muted-foreground text-sm uppercase tracking-wide">Free</p>
							<p className="mt-3 font-bold text-4xl tracking-tight">$0</p>
							<p className="mt-2 text-muted-foreground">Forever</p>
							<p className="mt-6 text-muted-foreground">
								Unlimited recording. 5 AI analyses/month. 1 project. Enough to see if it fits.
							</p>
							{user ? (
								<Link
									to={dashboardLink}
						...
						<div className="rounded-2xl border-2 border-amber-400 bg-card p-8">
							<p className="font-medium text-amber-600 text-sm uppercase tracking-wide dark:text-amber-400">Starter</p>
							<div className="mt-3 flex items-baseline gap-1">
								<span className="font-bold text-4xl tracking-tight">$15</span>
								<span className="text-muted-foreground">/mo</span>
							</div>
							<p className="mt-2 text-muted-foreground">Billed monthly. $12/mo annual.</p>
							<p className="mt-6 text-muted-foreground">
								Unlimited AI analyses. 3 projects. Smart personas and interview guides. Built for solo discovery.
							</p>
							{user ? (
								<Link
									to={dashboardLink}
						...
						{/* Teams */}
						<div className="rounded-2xl border bg-card p-8">
							<p className="font-medium text-muted-foreground text-sm uppercase tracking-wide">Teams & Enterprise</p>
							<p className="mt-3 font-bold text-4xl tracking-tight">Let's talk</p>
							<p className="mt-2 text-muted-foreground">Custom for your team</p>
							<p className="mt-6 text-muted-foreground">
								Shared evidence libraries, team annotations, SSO, unlimited viewer seats, and onboarding support.
							</p>
							<a
								href="https://cal.com/rickmoy"
								target="_blank"
				...
				<section className="px-6 py-24 md:py-32">
					<div className="mx-auto max-w-3xl text-center">
						...
						<p className="mx-auto mt-6 max-w-xl text-lg text-muted-foreground">
							Upload five conversations. See the synthesis. Check the receipts. Then decide.
						</p>
