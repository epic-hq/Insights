...
const defaultBenefits: Benefit[] = [
  {
    ...
    description:
      "Click any insight to see exactly who said it. Trust that's verified, not hallucinated.",
    icon: CheckCircle2,
  },
  {
  ...
  },
  {
    ...
    description:
      "Insights roll into tasks with owners. Evidence stays attached. Research that actually ships.",
    icon: Target,
  },
  {
...
const defaultSteps: Step[] = [
  ...
  },
  {
    ...
    description:
      "Quotes, themes, personas, and key facts—automatically identified and linked to who said it.",
    icon: Sparkles,
  },
  {
    title: "Search & synthesize",
    description:
      "Ask questions across all conversations. Get answers grounded in real customer words.",
    icon: Search,
  },
  {
    title: "Decide with confidence",
    description:
      "Evidence powers decisions, not opinions. Share stories and reels with stakeholders.",
    icon: Target,
  },
];
