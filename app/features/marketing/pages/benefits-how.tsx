...
const defaultBenefits: Benefit[] = [
  {
    ...
    description:
      "Click any insight to see exactly who said it, when, and why it matters. Trust that's earned, not generated.",
    icon: CheckCircle2,
  },
  {
    title: "One truth, shared",
    description:
      "Sales, Product, CS — everyone sees the same customer reality. No more silos or 'I think I heard...'",
    icon: Users,
  },
  {
    title: "From conversation to decision",
    description:
      "Ask any question, get answers grounded in real conversations. Decisions backed by what customers actually said.",
    icon: Target,
  },
  {
    title: "The CRM that remembers",
    description:
      "Notes, calls, surveys — captured and connected so nothing gets lost. Your customers told you everything.",
    icon: Lightbulb,
  },
];
...
const defaultSteps: Step[] = [
  {
    ...
    description:
      "Pick a goal, get tailored question sets, and avoid leading prompts.",
    icon: ListChecks,
  },
  {
    title: "Run interviews with confidence",
    description:
      "Lightweight guide, live notes, and smart cues keep you on track.",
    icon: MessageSquare,
  },
  {
    title: "Tag evidence & auto-extract insights",
    description:
      "Map quotes to pains, behaviors, and segments; generate takeaways you can defend.",
    icon: Sparkles,
  },
  {
        ...
        {benefits.map((benefit) => (
          <motion.li key={benefit.title} variants={item}>
            <Card className="group hover:-translate-y-2 h-full border border-border/50 bg-white/90 shadow-sm transition-all duration-300 hover:border-orange-200 hover:shadow-xl dark:border-border/40 dark:bg-slate-900/80">
              ...
              <CardContent>
                <p className="text-pretty text-base text-slate-700 leading-relaxed md:text-lg">
                  {benefit.description}
                </p>
              </CardContent>
            </Card>
