        ...
        <div className="container mx-auto max-w-2xl px-4 py-12 md:py-20">
          ...
          <div className="mb-10 text-center">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400">
              Download call recordings from Apollo.io share links with one
              click.
            </p>
          </div>

          {/* Bookmarklet drag area */}
          <div className="mb-12 rounded-2xl border-2 border-dashed border-slate-300 bg-white/60 px-8 py-10 text-center backdrop-blur-sm dark:border-slate-700 dark:bg-slate-900/60">
            ...
            <a
              ...
              className="inline-block cursor-grab select-none rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 px-7 py-3 font-semibold text-base text-white shadow-lg shadow-blue-500/25 transition-opacity hover:opacity-90 active:cursor-grabbing"
              onClick={(e) => {
                e.preventDefault();
                alert(
          ...
          <div className="space-y-10">
            <section>
              ...
              <ol className="space-y-4">
                ...
                <Step n={2}>
                  <strong>Drag the purple button</strong> above onto your
                  bookmarks bar.
                  <br />
                  <span className="text-slate-500">
                    You'll see "Download Apollo Video" appear as a bookmark.
                  </span>
                </Step>
              </ol>
            </section>
            ...
            <section>
              ...
              <ol className="space-y-4">
                <Step n={1}>
                  ...
                  <br />
                  <span className="text-slate-500">
                    Make sure you're logged into Apollo and can see the video
                    player.
                  </span>
                </Step>
                <Step n={2}>
                  <strong>Wait for the video to load</strong> — you should see
                  the video player on the page.
                </Step>
                <Step n={3}>
                  <strong>Click "Download Apollo Video"</strong> in your
                  bookmarks bar.
                  <br />
                  <span className="text-slate-500">
                    The video file will start downloading to your Downloads
                    folder.
                  </span>
                </Step>
                <Step n={4}>
                  <strong>Upload the downloaded file</strong> to UpSight using
          ...
          <div className="mt-10 rounded-xl border border-amber-200 bg-amber-50/80 px-5 py-4 text-amber-900 text-sm dark:border-amber-800/50 dark:bg-amber-950/30 dark:text-amber-200">
            <strong>Note:</strong> You must be logged into Apollo.io in the same
            browser for this to work. The bookmarklet finds the video URL on the
            page and triggers a download — it does not send any data anywhere.
          </div>
        </div>
      </main>
    </div>
