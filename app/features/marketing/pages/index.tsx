...
const PEOPLE: PersonData[] = [
  {
    ...
    imgSrcSet:
      "/images/hero/sarah-240.webp 240w, /images/hero/sarah-320.webp 320w, /images/hero/sarah-480.webp 480w",
    tilt: "rotate(-2.5deg)",
    annotations: [
      {
        label: "Engage",
  ...
  },
  {
    ...
    imgSrcSet:
      "/images/hero/priya-240.webp 240w, /images/hero/priya-320.webp 320w, /images/hero/priya-480.webp 480w",
    tilt: "rotate(-1.2deg)",
    annotations: [
      {
        label: "Engage",
    ...
    >
      ...
      <section
        ...
        style={{
          padding: "clamp(4rem, 10vw, 8rem) clamp(1.5rem, 4vw, 5rem)",
          background:
            "radial-gradient(ellipse at 50% 0%, rgba(245,158,11,0.03), transparent 50%), var(--lp-bg)",
        }}
      >
        <div
      ...
      <section
        ...
        style={{
          ...
          background:
            "radial-gradient(ellipse at 50% 70%, rgba(245,158,11,0.05), transparent 50%), var(--lp-bg)",
        }}
      >
        <h2
          className="lp-rv"
