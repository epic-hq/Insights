import { ArrowRight, Briefcase, CheckCircle2, CircleAlert, Clock3, DollarSign, Quote, Users } from "lucide-react";
...
export const meta: MetaFunction = () => {
	return [
		{
			title: "Customer Discovery for Consultants | Defensible SOW and Implementation Plans | UpSight",
		},
		{
			name: "description",
			content:
...
const consultantFlow = [
	...
	},
	{
		...
		description: "AI maps alignment gaps, execution constraints, and priorities across every stakeholder conversation.",
	},
	{
		step: "03",
		title: "Defend",
			...
			<section className="border-b bg-gradient-to-b from-zinc-950 via-zinc-900 to-zinc-800 px-6 py-24 text-white md:py-32">
				<div className="mx-auto max-w-5xl">
					...
					<p className="mt-8 max-w-2xl text-xl text-zinc-300 leading-relaxed md:text-2xl">
						You run 8 stakeholder interviews. Then spend 3 days turning notes into a SOW. UpSight does the synthesis in
						minutes — so you walk in with clarity, not chaos.
					</p>
					...
					<div className="mt-14 grid gap-4 sm:grid-cols-3">
						{[
							...
							<div key={item.label} className="rounded-xl border border-white/20 bg-white/5 p-5">
								<div className="flex items-center gap-2 text-amber-300">
									<item.icon className="h-4 w-4" />
									<span className="font-medium text-xs uppercase tracking-wide">{item.label}</span>
								</div>
								<p className="mt-2 font-semibold text-lg text-white">{item.value}</p>
							</div>
						))}
					</div>
				</div>
			...
			<section className="px-6 py-24 md:py-32">
				<div className="mx-auto max-w-4xl">
					...
					<div className="mt-10 space-y-6 text-lg text-muted-foreground leading-relaxed md:text-xl">
						<p>
							Discovery is the hard part of consulting. Not because interviews are difficult — but because turning 8
							conversations into a defensible recommendation takes days of stitching, cross-referencing, and
							second-guessing.
						</p>
						<p className="font-medium text-foreground">
							Your senior talent shouldn't be synthesizing notes. They should be driving decisions.
						</p>
					</div>
				</div>
			</section>
			...
			<section className="border-y bg-accent/20 px-6 py-24 md:py-32">
				<div className="mx-auto max-w-5xl">
					...
					<p className="mt-4 max-w-2xl text-lg text-muted-foreground">
						Built for consulting delivery economics — not academic research timelines.
					</p>
			...
			<section className="px-6 py-24 md:py-32">
				<div className="mx-auto max-w-4xl text-center">
					...
					<p className="mx-auto mt-8 max-w-2xl text-lg text-muted-foreground md:text-xl">
						Click any recommendation and see exactly which stakeholder said it, when, in what context. When leadership
						pushes back, you don't argue from memory. You point to evidence.
					</p>
				</div>
			</section>
			...
			<section className="border-y px-6 py-24 md:py-32">
				<div className="mx-auto max-w-5xl">
					...
					<p className="mt-4 max-w-2xl text-muted-foreground">
						Because polished output without source-linked evidence is just an expensive guess.
					</p>
					...
					<div className="mt-12 space-y-4">
						...
						<div className="grid gap-4 rounded-lg border-2 border-amber-400 bg-amber-50 p-5 text-sm sm:grid-cols-3 md:text-base dark:bg-amber-950/40">
							...
							<div className="text-amber-700 dark:text-amber-400">Defensible recommendations, lower rework risk</div>
						</div>
					</div>
				</div>
			</section>
			...
			<section className="px-6 py-24 md:py-32">
				<div className="mx-auto max-w-3xl text-center">
					...
					<p className="mx-auto mt-6 max-w-xl text-lg text-muted-foreground">
						See what happens when your discovery synthesis takes minutes instead of days.
					</p>
