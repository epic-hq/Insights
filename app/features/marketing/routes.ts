...
export default [
	...
	route("video-downloader", "./features/marketing/pages/video-downloader.tsx"),
	...
	layout("./features/marketing/layouts/MarketingLayout.tsx", [
		...
		route("customer-discovery-for-consultants", "./features/marketing/pages/customer-discovery-for-consultants.tsx"),
