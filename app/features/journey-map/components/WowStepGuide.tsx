...
export function WowStepGuide({ wowPath, wowSettings, counts, routes, onSkipToJourney }: WowStepGuideProps) {
		...
		<div className="relative flex min-h-full w-full items-center justify-center bg-background px-4 py-12">
			...
			<div className="w-full max-w-lg space-y-8">
				...
				<motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="text-center">
					<span className={cn("mb-2 inline-block rounded-full px-3 py-1 font-medium text-xs", accentClasses.badge)}>
