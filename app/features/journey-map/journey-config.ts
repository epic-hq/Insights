...
export const JOURNEY_PHASES: JourneyPhaseConfig[] = [
	{
		...
		isComplete: (counts, jp) =>
			jp.contextComplete && jp.promptsComplete && (counts.surveyResponses ?? 0) > 0 && (counts.people ?? 0) > 0,
		cards: [
			{
				id: "context-goals",
				title: "Context & Goals",
				...
				completionCheck: (_counts, jp) => jp.contextComplete && jp.promptsComplete,
			},
			{
				id: "create-survey",
	...
	},
	{
		...
		title: "Find Patterns",
		icon: Layers,
		isComplete: (counts) => (counts.themes ?? 0) > 0 && (counts.insights ?? 0) > 0,
		cards: [
			{
				id: "explore-themes",
