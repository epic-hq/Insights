 ...
 * When a person's title is updated, automatically create/update their job_function facet
 */
export async function syncTitleToJobFunctionFacet({
	supabase,
	personId,
	accountId,
	title,
	...
	try {
		...
		// Upsert person_facet linking person to the job_function facet
