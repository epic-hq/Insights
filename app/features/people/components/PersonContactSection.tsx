...
import { ExternalLink, Globe, Instagram, Linkedin, Mail, MapPin, Phone, Plus, Twitter } from "lucide-react";
		...
		<>
			...
			{!isEditing && !hasAnyContact && (
				<button
					...
					className={cn(
						"flex items-center gap-1.5 text-muted-foreground/60 text-sm italic",
