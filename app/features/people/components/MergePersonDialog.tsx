    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Merge "{sourcePerson.name || "Unnamed Person"}" into another person.
            All evidence, interviews, and attributes will be transferred.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="rounded-lg border bg-muted/30 p-4">
            ...
            <p className="mb-1 font-semibold">
              {sourcePerson.name || "Unnamed Person"}
            </p>
                  ...
                  {availablePeople
                    ...
                    .map((person) => (
                      <CommandItem
                        ...
                        className={
                          targetPersonId === person.id ? "bg-accent" : ""
                        }
                      >
          ...
          {targetPerson && (
            <div className="rounded-lg border border-green-200 bg-green-50/50 p-4 dark:border-green-800/50 dark:bg-green-950/20">
              ...
              <p className="mt-2 text-green-700 text-xs dark:text-green-400">
                All data from "{sourcePerson.name || "Unnamed Person"}" will be
          ...
          <div className="rounded-lg border border-yellow-200 bg-yellow-50/50 p-3 dark:border-yellow-800/50 dark:bg-yellow-950/20">
            ...
            <p className="mt-1 text-xs text-yellow-700 dark:text-yellow-400">
              The source person record will be soft-deleted and can be restored
              from the merge history if needed.
            </p>
          </div>
        </div>
