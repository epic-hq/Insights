...
const mockExtractEvidence = b.ExtractEvidenceFromTranscriptV2 as ReturnType<
  typeof vi.fn
>;
const mockDerivePersonaFacets = b.DerivePersonaFacetsFromEvidence as ReturnType<
  typeof vi.fn
>;
...
describe("Person Attribution Integration Tests", () => {
  ...
  beforeEach(async () => {
    ...
    if (interviewError || !interview)
      throw new Error("Failed to seed test interview");
    ...
    if (peopleError || !people || people.length !== 2)
      throw new Error("Failed to seed test people");
