...
export function UpgradeLimitModal({ info, open, onOpenChange }: UpgradeLimitModalProps) {
	if (!info.isExceeded) {
		return null;
	}
		...
		<AlertDialog open={open} onOpenChange={onOpenChange}>
			<AlertDialogContent>
				<AlertDialogHeader>
					...
					<AlertDialogTitle className="text-center">{info.limitName} Limit Reached</AlertDialogTitle>
					<AlertDialogDescription className="text-center">
						You've used {info.currentUsage} of {info.limit} {info.limitName.toLowerCase()} this month. Upgrade your plan
						to continue.
					</AlertDialogDescription>
				</AlertDialogHeader>
