...
export function FileUploadButton({ onFileContent, disabled = false, className, maxSizeMB = 5 }: FileUploadButtonProps) {
		...
		<TooltipProvider>
			<Tooltip>
				...
				<TooltipContent side="top">
					{error ? <p className="text-destructive">{error}</p> : <p>Upload CSV to import contacts</p>}
				</TooltipContent>
			</Tooltip>
			<input
				ref={inputRef}
