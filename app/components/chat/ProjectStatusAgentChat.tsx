...
export function ProjectStatusAgentChat({
  ...
  // Use "instant" on first load to avoid jarring animation, then "smooth" for updates
      ...
      requestAnimationFrame(() => {
        ...
        requestAnimationFrame(() => {
          if (messagesEndRef.current) {
            const behavior = hasInitialScrolledRef.current
              ? "smooth"
              : "instant";
                      ...
                      >
                        <div className="max-w-[85%]">
                          ...
                          <div
                            ...
                            onClick={
                              !isUser ? handleAssistantLinkClick : undefined
                            }
                          >
                            {messageText ? (
                              isUser ? (
