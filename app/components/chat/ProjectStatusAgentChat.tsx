...
export function ProjectStatusAgentChat({
  ...
  const toolSuggestions = useMemo(() => {
    ...
    if (displayableMessages.length === 0) {
      ...
      const interviews = interviewMatch ? parseInt(interviewMatch[1], 10) : 0;
      const evidence = evidenceMatch ? parseInt(evidenceMatch[1], 10) : 0;
      const insights = insightsMatch ? parseInt(insightsMatch[1], 10) : 0;
