...
export default function CopilotChat({ 
  ...
  return (
    <div className={cn(
      ...
      {/* Chat Panel */}
      <div className={cn(
        "absolute bg-gray-900 border-gray-700 transition-all duration-300",
        // Mobile: bottom panel
        "bottom-0 left-0 right-0 h-1/2 border-t-2",
        // Desktop: right sidebar  
        "lg:right-0 lg:left-auto lg:top-0 lg:bottom-0 lg:h-full lg:w-96 lg:border-t-0 lg:border-l-2",
            ...
            <div className="border-t border-gray-700 p-4">
              <div className="flex gap-2">
                <Input
                  ...
                  className="flex-1 bg-gray-800 border-gray-600 text-white placeholder:text-gray-400 focus:border-indigo-500"
                  disabled={isLoading}
                />
                <Button 
                  onClick={sendMessage}
