	...
	return (
		<div className="mx-auto max-w-7xl px-4 py-8">
			...
			<div className="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-900">
				...
				<div className="h-16 w-full" style={{ backgroundColor: persona.color }} />
				...
				<div className="p-6">
					<div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between">
						...
						<div className="mt-4 flex items-center md:mt-0">
							<span className="mr-2 inline-block h-4 w-4 rounded-full" style={{ backgroundColor: persona.color }} />
							<span className="font-medium text-sm">Color identifier</span>
						</div>
					</div>
