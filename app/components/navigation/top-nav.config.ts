...
export const TOP_NAV_CATEGORIES: TopNavCategory[] = [
	{
		...
		title: "Plan",
		icon: Compass,
		description: "Set up your research: context, goals, interview guides, priorities",
		items: [
			{
				key: "context",
				title: "Context",
...
/**
 * Standalone top-level nav links (rendered as direct links, no dropdown)
 */
export const TOP_NAV_STANDALONE_ITEMS: TopNavItem[] = [
	{
		key: "tasks",
		title: "Tasks",
		icon: CheckSquare,
