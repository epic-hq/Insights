...
export function JourneySidebarGroup({ basePath, currentPhase, planSubStep, progress }: JourneySidebarGroupProps) {
	...
	const getPhaseStatus = (phase: JourneyPhase): "complete" | "current" | "upcoming" => {
	...
	const getSubStepStatus = (subStep: PlanSubStep): "complete" | "current" | "upcoming" => {
		...
		<SidebarGroup>
			...
			<SidebarGroupContent>
				<SidebarMenu>
					...
					<Collapsible defaultOpen={currentPhase === "plan"} className="group/collapsible">
						<SidebarMenuItem>
							<CollapsibleTrigger asChild>
								<SidebarMenuButton
									className={cn(
										planStatus === "current" && "text-primary",
										planStatus === "complete" && "text-green-600 dark:text-green-400"
									)}
								>
									{planStatus === "complete" ? (
								...
								<SidebarMenuSub>
									...
									<SidebarMenuSubItem>
										<SidebarMenuSubButton
											...
											className={cn(contextStatus === "complete" && "text-green-600 dark:text-green-400")}
										>
									...
									<SidebarMenuSubItem>
										<SidebarMenuSubButton
											...
											className={cn(promptsStatus === "complete" && "text-green-600 dark:text-green-400")}
										>
					...
					<SidebarMenuItem>
						<SidebarMenuButton
							...
							className={cn(
								collectStatus === "complete" && "text-green-600 dark:text-green-400",
					...
					<SidebarMenuItem>
						<SidebarMenuButton
							...
							className={cn(
								learnStatus === "complete" && "text-green-600 dark:text-green-400",
