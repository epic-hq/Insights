...
function MobileNavItem({ item, routes, onClose }: { item: TopNavItem; routes: ReturnType<typeof useProjectRoutes>; onClose: () => void }) {
	const href = item.to(routes)
	return (
		<NavLink
			to={href}
...
export function TopNavigation({ accounts = [], onToggleAIPanel, isAIPanelOpen, className }: TopNavigationProps) {
	...
	const getActiveCategory = () => {
		...
		if (path.includes("/setup") || path.includes("/questions") || path.includes("/priorities")) return "plan"
				...
				<div className="flex w-full items-center gap-4 px-4">
					...
					<div className="flex items-center gap-2 ml-auto">
						...
						>
							...
							<span className="text-muted-foreground text-sm">Ask or search...</span>
						</Button>
