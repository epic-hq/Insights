          ...
          <TableBody>
            <TableRow>
              ...
              <TableCell colSpan={2}>
                <Button
                  variant="outline"
                  onClick={() =>
                    setFilters({ tag: "", category: null, journeyStage: null, impact: null, novelty: null, confidence: null })
                  }
                >
                  Clear Filters
                </Button>
            ...
            {filteredAndSortedInsights.map(insight => (
              <TableRow key={insight.id}>
                ...
                <TableCell>
                  {insight.journeyStage && <Badge variant="outline">{insight.journeyStage}</Badge>}
                </TableCell>
                <TableCell>
                  {insight.impact != null && <Badge className={getImpactColor(Number(insight.impact))}>{insight.impact}</Badge>}
                </TableCell>
                <TableCell>
                  {insight.novelty != null && <Badge className={getNoveltyColor(Number(insight.novelty))}>{insight.novelty}</Badge>}
                </TableCell>
                <TableCell>
