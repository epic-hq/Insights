		...
		<SidebarProvider>
			<ProjectStatusAgentProvider>
				<div className="flex h-screen w-full flex-col">
					...
					{showResizablePanel ? (
						<ResizablePanelGroup direction="horizontal" className="min-h-0 flex-1" autoSaveId="ai-panel-layout">
							{/* AI Assistant Panel — resizable */}
							<ResizablePanel defaultSize={22} minSize={15} maxSize={45} order={1}>
								<AIAssistantPanel
							...
							<ResizablePanel defaultSize={78} order={2}>
								<main className={cn("flex h-full min-h-0 flex-col overflow-auto", showMobileNav ? "pb-[72px]" : "")}>
									<Outlet />
								</main>
							</ResizablePanel>
						</ResizablePanelGroup>
						...
						<div className="flex min-h-0 flex-1">
							...
							{/* Main content */}
							<main className={cn("flex min-h-0 flex-1 flex-col overflow-auto", showMobileNav ? "pb-[72px]" : "")}>
								<Outlet />
							</main>
						</div>
					)}
