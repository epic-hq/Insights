...
import { Clock4, Crown, Edit3, Eye, Mail, RefreshCw, UserMinus, Users, X } from "lucide-react";
...
interface TeamInviteProps {
	...
	onResendInvitation?: (email: string, role: string) => void;
										...
										{pendingInvitations.map((inv) => {
											...
											return (
												...
												>
													...
													<div className="min-w-0 flex-1">
														<div className="flex items-center gap-2">
															<p className="truncate font-medium text-sm">{inv.email || "(no email)"}</p>
															{isExpired ? (
																<Badge
																	variant="outline"
													...
													<div className="flex items-center gap-1">
														{onResendInvitation && inv.email && (
															<Button
																...
																onClick={() => onResendInvitation(inv.email!, inv.account_role)}
														...
														{onRevokeInvitation && (
															<Button
																...
																onClick={() => onRevokeInvitation(inv.invitation_id)}
