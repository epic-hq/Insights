...
const envSchema = z.object({
	...
	SUPABASE_FUNCTIONS_URL: z.string().optional(),
        ...
        VOICE_AGENT_MODEL: z.string().optional(),
        VOICE_AGENT_CONTROL_URL: z.string().optional(),
        VOICE_AGENT_CONTROL_SECRET: z.string().optional(),
        VOICE_AGENT_TURN_SILENCE_SECONDS: z.string().optional(),
