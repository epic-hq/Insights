...
export class BamlAsyncClient {
  ...
  async AnalyzeAskLinkResponses(
    ...
    try {
      ...
      if (options.onTick) {
        const stream = this.stream.AnalyzeAskLinkResponses(
      ...
      return raw.parsed(false) as types.AskLinkInsightsResponse
    } catch (error) {
  ...
  async ApplyConversationLens(
    ...
    try {
      ...
      // Check if onTick is provided - route through streaming if so
      if (options.onTick) {
        const stream = this.stream.ApplyConversationLens(
      ...
      return raw.parsed(false) as types.ConversationLensResult
    } catch (error) {
      throw toBamlError(error);
    }
  }
  ...
  async ExtractConversationTakeaways(
    ...
    try {
      ...
      // Check if onTick is provided - route through streaming if so
      if (options.onTick) {
        const stream = this.stream.ExtractConversationTakeaways(
  ...
  async ExtractEvidenceFromDocument(
    ...
    try {
      ...
      // Check if onTick is provided - route through streaming if so
      if (options.onTick) {
        const stream = this.stream.ExtractEvidenceFromDocument(
      ...
      return raw.parsed(false) as types.DocumentExtraction
    } catch (error) {
      throw toBamlError(error);
    }
  }
  ...
  async ExtractGoalLens(
    ...
    try {
      ...
      // Check if onTick is provided - route through streaming if so
      if (options.onTick) {
        const stream = this.stream.ExtractGoalLens(
  ...
  async ExtractProductLens(
    ...
    try {
      ...
      // Check if onTick is provided - route through streaming if so
      if (options.onTick) {
        const stream = this.stream.ExtractProductLens(
  ...
  async ExtractQAPairs(
    ...
    try {
      ...
      // Check if onTick is provided - route through streaming if so
      if (options.onTick) {
        const stream = this.stream.ExtractQAPairs(
      ...
      return raw.parsed(false) as types.QALensResult
    } catch (error) {
      throw toBamlError(error);
    }
  }
  ...
  async ExtractResearchLens(
    ...
    try {
      ...
      // Check if onTick is provided - route through streaming if so
      if (options.onTick) {
        const stream = this.stream.ExtractResearchLens(
          evidence_json,interview_context,
          __baml_options__
        );
  ...
  async ExtractSalesLensBant(
    ...
    try {
      ...
      // Check if onTick is provided - route through streaming if so
      if (options.onTick) {
        const stream = this.stream.ExtractSalesLensBant(
          evidence_json,interview_context,
          __baml_options__
        );
  ...
  async GenerateLensTemplate(
    ...
    try {
      ...
      // Check if onTick is provided - route through streaming if so
      if (options.onTick) {
        const stream = this.stream.GenerateLensTemplate(
      ...
      return raw.parsed(false) as types.GeneratedLensTemplate
    } catch (error) {
      throw toBamlError(error);
    }
  }
  ...
  async MapSpreadsheetColumns(
    ...
    try {
      ...
      // Check if onTick is provided - route through streaming if so
      if (options.onTick) {
        const stream = this.stream.MapSpreadsheetColumns(
      ...
      return raw.parsed(false) as types.SpreadsheetAnalysis
    } catch (error) {
      throw toBamlError(error);
    }
  }
  ...
  async ParseSurveyGuidelines(
    ...
    try {
      ...
      // Check if onTick is provided - route through streaming if so
      if (options.onTick) {
        const stream = this.stream.ParseSurveyGuidelines(
      ...
      return raw.parsed(false) as types.GuidelineParseResult
    } catch (error) {
      throw toBamlError(error);
    }
  }
  ...
  async SummarizeAskLinkResponses(
    ...
    try {
      ...
      // Check if onTick is provided - route through streaming if so
      if (options.onTick) {
        const stream = this.stream.SummarizeAskLinkResponses(
      ...
      return raw.parsed(false) as types.QuickResponseSummary
    } catch (error) {
      throw toBamlError(error);
    }
  }
  ...
  async SynthesizeCrossLensInsights(
    ...
    try {
      ...
      // Check if onTick is provided - route through streaming if so
      if (options.onTick) {
        const stream = this.stream.SynthesizeCrossLensInsights(
      ...
      return raw.parsed(false) as types.CrossLensSynthesisResult
    } catch (error) {
      throw toBamlError(error);
    }
  }
  ...
  async SynthesizeLensInsights(
    ...
    try {
      ...
      // Check if onTick is provided - route through streaming if so
      if (options.onTick) {
        const stream = this.stream.SynthesizeLensInsights(
      ...
      return raw.parsed(false) as types.LensSynthesisResult
    } catch (error) {
      throw toBamlError(error);
    }
  }
