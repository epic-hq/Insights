...
export class BamlSyncClient {
	...
	CreateSet(instructions: string, __baml_options__?: BamlCallOptions): types.Set {
		try {
			const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
			const collector = options.collector
				? Array.isArray(options.collector)
	...
	ExtractEvidence(doc: types.InterviewDoc, __baml_options__?: BamlCallOptions): types.EvidenceSet {
		try {
			const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
			const collector = options.collector
				? Array.isArray(options.collector)
	...
	FindSpectrum(evidence: types.EvidenceSet, __baml_options__?: BamlCallOptions): types.Spectrum {
		try {
			const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
			const collector = options.collector
				? Array.isArray(options.collector)
	...
	GenerateQuestionSet(inputs: types.GenerateInputs, __baml_options__?: BamlCallOptions): types.QuestionSet {
		try {
			const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
			const collector = options.collector
				? Array.isArray(options.collector)
	...
	NormalizeNotes(raw_notes: string, __baml_options__?: BamlCallOptions): types.InterviewDoc {
		try {
			const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
			const collector = options.collector
				? Array.isArray(options.collector)
