...
export default class TypeBuilder {
	...
	AutoInsightsResponse: ClassViewer<
	...
	InterviewExtraction: ClassViewer<
		"InterviewExtraction",
	...
	OpportunityRecommendation: ClassViewer<
	...
	PersonaAssignmentDecision: ClassViewer<
	...
	ResearchQuestionSuggestions: ClassViewer<
	...
	constructor() {
		this.tb = new _TypeBuilder({
			...
			enums: new Set(["BBValues", "Emotions"]),
			runtime: DO_NOT_USE_DIRECTLY_UNLESS_YOU_KNOW_WHAT_YOURE_DOING_RUNTIME,
		})

		this.ActionButton = this.tb.classViewer("ActionButton", ["label", "action_type", "parameters", "priority"])

		this.Anchor = this.tb.classViewer("Anchor", ["type", "target", "start", "end"])

		this.AutoGroupThemesResponse = this.tb.classViewer("AutoGroupThemesResponse", ["themes"])
		...
		this.Category = this.tb.classViewer("Category", ["id", "label", "weight"])

		this.Chapter = this.tb.classViewer("Chapter", ["start_ms", "end_ms", "summary", "title"])

		this.EvidenceLinkProposal = this.tb.classViewer("EvidenceLinkProposal", ["evidence_id", "rationale", "confidence"])
		...
		this.HistoryItem = this.tb.classViewer("HistoryItem", ["questionId", "action", "ts", "interviewId"])
		...
		this.InterviewDoc = this.tb.classViewer("InterviewDoc", ["source", "snippets"])
		...
		this.InterviewMetadata = this.tb.classViewer("InterviewMetadata", ["title", "date", "interviewer", "durationMin"])
		...
		this.KindTags = this.tb.classViewer("KindTags", ["problem", "goal", "behavior", "emotion", "context", "artifact"])

		this.NoteSnippet = this.tb.classViewer("NoteSnippet", ["tag", "text", "speaker", "timestamp"])
		...
		this.PersonaSet = this.tb.classViewer("PersonaSet", ["personas", "version", "change_log", "contrast_persona"])
		...
		this.ResearchGoal = this.tb.classViewer("ResearchGoal", ["goal", "icp", "role", "questions"])

		this.ResearchQuestion = this.tb.classViewer("ResearchQuestion", ["question", "priority"])
		...
		this.Scores = this.tb.classViewer("Scores", ["goalMatch", "novelty", "importance", "uncertainty"])

		this.Set = this.tb.classViewer("Set", ["name", "description", "members"])

		this.SetRecord = this.tb.classViewer("SetRecord", ["term", "definition"])

		this.Source = this.tb.classViewer("Source", [])

		this.Spectrum = this.tb.classViewer("Spectrum", ["axis", "rationale", "supporting_evidence", "alternatives"])
