...
async function testBAMLIntegration() {
  console.log('Testing BAML function integration...')
  
  try {
    // Test 1: Research Questions Generation
    console.log('\n1. Testing GenerateResearchQuestions...')
    const questions = await b.GenerateResearchQuestions(
      'pizza shop owners', 
      'small business owners', 
      'understand operational challenges'
    )
    console.log('✅ Questions generated:', questions.core_questions?.length || 0, 'core questions')
    
    // Test 2: Quick Insights Generation
    console.log('\n2. Testing GenerateQuickInsights...')
    const insights = await b.GenerateQuickInsights(
    ...
    console.log('✅ Quick insights generated:', {
      findings: insights.key_findings?.length || 0,
      completion: insights.completion_percentage,
